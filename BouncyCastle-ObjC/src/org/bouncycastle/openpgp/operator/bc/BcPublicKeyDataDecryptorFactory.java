        ...
        throws PGPException
    {
        try
        {
            ...
            else
            {
                ...
                OpenPgpBcRFC6637KDFCalculator rfc6637KDFCalculator = new OpenPgpBcRFC6637KDFCalculator(new BcPGPDigestCalculatorProvider().get(ecKey.getHashAlgorithm()), ecKey.getSymmetricKeyAlgorithm());
