...
public class PqcJcajceSphincsSignatureSpi
    extends java.security.SignatureSpi
{
    ...
    protected PqcJcajceSphincsSignatureSpi(Digest digest, ASN1ObjectIdentifier treeDigest, SPHINCS256Signer signer)
    {
        this.digest = digest;
...
//            }
    ...
    static public class withSha512
        extends PqcJcajceSphincsSignatureSpi
    {
        public withSha512()
        {
