    ...
    implements PrivateKey, SPHINCSKey
{
        ...
        throws IOException
    {
        ...
        this.params = (SPHINCSPrivateKeyParameters) PqcCryptoPrivateKeyFactory.createKey(keyInfo);
    }
    ...
    public byte[] getEncoded()
    {
        ...
        try
        {
            ...
            {
                pki = PqcCryptoPrivateKeyInfoFactory.createPrivateKeyInfo(params, attributes);
            }
            else
            {
