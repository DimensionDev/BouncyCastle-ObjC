...
import org.bouncycastle.pqc.crypto.util.PqcCryptoPublicKeyFactory;
import org.bouncycastle.pqc.crypto.util.PqcSubjectPublicKeyInfoFactory;
    ...
    implements PublicKey, SPHINCSKey
{
        ...
        throws IOException
    {
        ...
        this.params = (SPHINCSPublicKeyParameters) PqcCryptoPublicKeyFactory.createKey(keyInfo);
    }
    ...
    public byte[] getEncoded()
    {
        try
        {
            ...
            {
                pki = PqcSubjectPublicKeyInfoFactory.createSubjectPublicKeyInfo(params);
            }
            else
            {
