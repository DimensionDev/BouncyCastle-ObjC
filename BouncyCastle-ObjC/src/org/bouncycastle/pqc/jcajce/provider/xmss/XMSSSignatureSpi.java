    ...
    implements StateAwareSignature
{
        ...
        throws InvalidKeyException
    {
        ...
        {
            throw new InvalidKeyException("unknown public key passed to PqcJcajceXMSS");
        }
    }
        ...
        throws InvalidKeyException
    {
        ...
        {
            throw new InvalidKeyException("unknown private key passed to PqcJcajceXMSS");
        }
    }
    ...
    protected byte[] engineSign()
        throws SignatureException
    {
        byte[] hash = PqcJcajceXmssDigestUtil.getDigestResult(digest);
        ...
        extends XMSSSignatureSpi
    {
        public withSha256()
        {
            super("PqcJcajceXMSS-SHA256", new NullDigest(), new XMSSSigner());
        }
    }
        ...
        extends XMSSSignatureSpi
    {
        public withShake128()
        {
            super("PqcJcajceXMSS-SHAKE128", new NullDigest(), new XMSSSigner());
        }
    }
        ...
        extends XMSSSignatureSpi
    {
        public withSha512()
        {
            super("PqcJcajceXMSS-SHA512", new NullDigest(), new XMSSSigner());
        }
    }
        ...
        extends XMSSSignatureSpi
    {
        public withShake256()
        {
            super("PqcJcajceXMSS-SHAKE256", new NullDigest(), new XMSSSigner());
        }
    }
