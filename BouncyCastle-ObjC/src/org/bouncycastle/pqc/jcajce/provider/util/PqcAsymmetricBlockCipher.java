...
/**
 * The PqcAsymmetricBlockCipher class extends CipherSpiExt.
 ...
 */
public abstract class PqcAsymmetricBlockCipher
    extends CipherSpiExt
{
    ...
    /**
     * The PqcAsymmetricBlockCipher() constructor
     */
    public PqcAsymmetricBlockCipher()
    {
    ...
    /**
     * This method initializes the PqcAsymmetricBlockCipher with a certain key for
     * data encryption.
     * <p>
    ...
    /**
     * Initialize the PqcAsymmetricBlockCipher with a certain key for data
     * encryption.
     *
     * @param key    the key which has to be used to encrypt data
     * @param params the algorithm parameters
