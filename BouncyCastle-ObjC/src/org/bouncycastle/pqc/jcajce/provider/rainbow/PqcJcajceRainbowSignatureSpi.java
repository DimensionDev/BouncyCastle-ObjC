...
/**
 * Rainbow Signature class, extending the jce JcajceEcSignatureSpi.
 */
public class PqcJcajceRainbowSignatureSpi
    extends java.security.SignatureSpi
{
    ...
    protected PqcJcajceRainbowSignatureSpi(Digest digest, RainbowSigner signer)
    {
        this.digest = digest;
        this.signer = signer;
    }
    ...
    static public class withSha224
        extends PqcJcajceRainbowSignatureSpi
    {
        public withSha224()
        {
