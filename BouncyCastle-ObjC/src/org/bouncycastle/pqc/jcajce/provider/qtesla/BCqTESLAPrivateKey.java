    ...
    implements PrivateKey, QTESLAKey
{
        ...
        throws IOException
    {
        ...
        this.keyParams = (QTESLAPrivateKeyParameters) PqcCryptoPrivateKeyFactory.createKey(keyInfo);
    }
    ...
    public byte[] getEncoded()
    {
        ...
        try
        {
            pki = PqcCryptoPrivateKeyInfoFactory.createPrivateKeyInfo(keyParams, attributes);
