...
public class SPHINCS
{
        ...
        extends AsymmetricAlgorithmProvider
    {
        ...
        public void configure(ConfigurableProvider provider)
        {
            ...
            addSignatureAlgorithm(provider, "SHA512", "SPHINCS256", PREFIX + "PqcJcajceSphincsSignatureSpi$withSha512", PQCObjectIdentifiers.sphincs256_with_SHA512);
            addSignatureAlgorithm(provider, "SHA3-512", "SPHINCS256", PREFIX + "PqcJcajceSphincsSignatureSpi$withSha3_512", PQCObjectIdentifiers.sphincs256_with_SHA3_512);
