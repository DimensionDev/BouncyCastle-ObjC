    ...
    extends GF2nElement
{
    ...
    // the used PqcMathGF2Polynomial which stores the coefficients
    private PqcMathGF2Polynomial polynomial;
    ...
    public GF2nPolynomialElement(GF2nPolynomialField f, Random rand)
    {
        ...
        polynomial = new PqcMathGF2Polynomial(mDegree);
        randomize(rand);
    }
     ...
     */
    public GF2nPolynomialElement(GF2nPolynomialField f, PqcMathGF2Polynomial bs)
    {
        mField = f;
        mDegree = mField.getDegree();
        polynomial = new PqcMathGF2Polynomial(bs);
    ...
    public GF2nPolynomialElement(GF2nPolynomialField f, byte[] os)
    {
        mField = f;
        mDegree = mField.getDegree();
        polynomial = new PqcMathGF2Polynomial(mDegree, os);
        polynomial.expandN(mDegree);
    }
    ...
    public GF2nPolynomialElement(GF2nPolynomialField f, int[] is)
    {
        mField = f;
        mDegree = mField.getDegree();
        polynomial = new PqcMathGF2Polynomial(mDegree, is);
    ...
    public GF2nPolynomialElement(GF2nPolynomialElement other)
    {
        ...
        polynomial = new PqcMathGF2Polynomial(other.polynomial);
    }
    ...
    /**
     * Assigns the value 'zero' to this PqcMathPolynomial.
     */
    void assignZero()
    {
    ...
    {
        PqcMathGF2Polynomial polynomial = new PqcMathGF2Polynomial(f.getDegree());
    ...
    /**
     * Assigns the value 'one' to this PqcMathPolynomial.
     */
    void assignOne()
    {
     ...
     */
    private PqcMathGF2Polynomial getGF2Polynomial()
    {
        return new PqcMathGF2Polynomial(polynomial);
    }
        ...
        throws ArithmeticException
    {
        ...
        PqcMathGF2Polynomial b = new PqcMathGF2Polynomial(mDegree + 32, "ONE");
        b.reduceN();
        PqcMathGF2Polynomial c = new PqcMathGF2Polynomial(mDegree + 32);
        c.reduceN();
        PqcMathGF2Polynomial u = getGF2Polynomial();
        PqcMathGF2Polynomial v = mField.getFieldPolynomial();
        PqcMathGF2Polynomial h;
        int j;
        u.reduceN();
        while (!u.isOne())
        {
        ...
        throws ArithmeticException
    {
        ...
        PqcMathGF2Polynomial b = new PqcMathGF2Polynomial(mDegree, "ONE");
        PqcMathGF2Polynomial c = new PqcMathGF2Polynomial(mDegree);
        PqcMathGF2Polynomial u = getGF2Polynomial();
        PqcMathGF2Polynomial v = mField.getFieldPolynomial();
        PqcMathGF2Polynomial h;
        while (true)
     ...
     *
     * @return <tt>this<sup>2</sup></tt> (newly created)
     * @see PqcMathGF2Polynomial#vectorMult
     * @see GF2nPolynomialElement#squarePreCalc
    ...
    {
        PqcMathGF2Polynomial result = new PqcMathGF2Polynomial(mDegree);
     ...
     * @see GF2nPolynomialElement#squarePreCalc
     * @see PqcMathGF2Polynomial#squareThisBitwise
     */
     ...
     * @return <tt>this<sup>2</sup></tt> (newly created)
     * @see GF2nPolynomialElement#squareMatrix
     * @see PqcMathGF2Polynomial#squareThisPreCalc
     */
     ...
     *
     * @see PqcMathGF2Polynomial#reduceTrinomial
     * @see PqcMathGF2Polynomial#reducePentanomial
     */
