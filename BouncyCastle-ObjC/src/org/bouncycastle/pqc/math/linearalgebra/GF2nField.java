...
public abstract class GF2nField
{
     ...
     */
    protected PqcMathGF2Polynomial fieldPolynomial;
     ...
     */
    public final PqcMathGF2Polynomial getFieldPolynomial()
    {
        if (fieldPolynomial == null)
        {
            computeFieldPolynomial();
        }
        return new PqcMathGF2Polynomial(fieldPolynomial);
    }
     ...
     */
    protected abstract GF2nElement getRandomRoot(PqcMathGF2Polynomial B0FieldPolynomial);
     ...
     * @return matrix^(-1)
     */
    protected final PqcMathGF2Polynomial[] invertMatrix(PqcMathGF2Polynomial[] matrix)
    {
        PqcMathGF2Polynomial[] a = new PqcMathGF2Polynomial[matrix.length];
        PqcMathGF2Polynomial[] inv = new PqcMathGF2Polynomial[matrix.length];
        PqcMathGF2Polynomial dummy;
        int i, j;
        // initialize a as a copy of matrix and inv as E(inheitsmatrix)
        for (i = 0; i < mDegree; i++)
        {
            a[i] = new PqcMathGF2Polynomial(matrix[i]);
            inv[i] = new PqcMathGF2Polynomial(mDegree);
        ...
        throws RuntimeException
    {
        ...
        int i;
        PqcMathGF2Polynomial[] COBMatrix;
        ...
        COBMatrix = (PqcMathGF2Polynomial[])matrices.elementAt(i);
        ...
        PqcMathGF2Polynomial bs = new PqcMathGF2Polynomial(mDegree, elemCopy.toFlexiBigInt());
        bs.expandN(mDegree);
