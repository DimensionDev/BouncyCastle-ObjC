    ...
    extends GF2nField
{
     ...
     */
    PqcMathGF2Polynomial[] squaringMatrix;
     ...
     */
    public GF2nPolynomialField(int deg, SecureRandom random, PqcMathGF2Polynomial polynomial)
     ...
     */
    public PqcMathGF2Polynomial getSquaringVector(int i)
    {
        return new PqcMathGF2Polynomial(squaringMatrix[i]);
    }

    /**
     * Compute a random root of the given PqcMathGF2Polynomial.
     *
     * @param polynomial the polynomial
     * @return a random root of <tt>polynomial</tt>
     */
    protected GF2nElement getRandomRoot(PqcMathGF2Polynomial polynomial)
    {
        // We are in B1!!!
        GF2nPolynomial c;
        GF2nPolynomial ut;
    ...
    protected void computeCOBMatrix(GF2nField B1)
    {
        ...
        GF2nElement[] gamma;
        GF2nElement u;
        PqcMathGF2Polynomial[] COBMatrix = new PqcMathGF2Polynomial[mDegree];
        for (i = 0; i < mDegree; i++)
        {
            COBMatrix[i] = new PqcMathGF2Polynomial(mDegree);
        }
    ...
    {
        PqcMathGF2Polynomial[] d = new PqcMathGF2Polynomial[mDegree - 1];
        int i, j;
        squaringMatrix = new PqcMathGF2Polynomial[mDegree];
        for (i = 0; i < squaringMatrix.length; i++)
        {
            squaringMatrix[i] = new PqcMathGF2Polynomial(mDegree, "ZERO");
        }

        for (i = 0; i < mDegree - 1; i++)
        {
            d[i] = new PqcMathGF2Polynomial(1, "ONE").shiftLeft(mDegree + i)
    ...
    private boolean testTrinomials()
    {
        ...
        fieldPolynomial = new PqcMathGF2Polynomial(mDegree + 1);
