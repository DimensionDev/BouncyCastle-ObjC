...
public class NTRUSigner
{
    ...
    private IntegerPolynomial sign(IntegerPolynomial i, NTRUSigningPrivateKeyParameters kp)
    {
        ...
        while (iLoop >= 1)
        {
            PqcMathPolynomial f = kPriv.getBasis(iLoop).f;
            PqcMathPolynomial fPrime = kPriv.getBasis(iLoop).fPrime;
        ...
        PqcMathPolynomial f = kPriv.getBasis(0).f;
        PqcMathPolynomial fPrime = kPriv.getBasis(0).fPrime;
