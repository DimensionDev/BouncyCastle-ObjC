    ...
    extends AsymmetricKeyParameter
{
    ...
    {
        public PqcMathPolynomial f;
        public PqcMathPolynomial fPrime;
         ...
         */
        protected Basis(PqcMathPolynomial f, PqcMathPolynomial fPrime, IntegerPolynomial h, NTRUSigningKeyGenerationParameters params)
        {
            this.f = f;
            this.fPrime = fPrime;
            this.h = h;
        ...
        private byte[] getEncoded(PqcMathPolynomial p)
        {
