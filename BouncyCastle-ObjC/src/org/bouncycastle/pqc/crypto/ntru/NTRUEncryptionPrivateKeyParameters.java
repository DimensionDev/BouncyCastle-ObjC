    ...
    extends NTRUEncryptionKeyParameters
{
     ...
     */
    public NTRUEncryptionPrivateKeyParameters(IntegerPolynomial h, PqcMathPolynomial t, IntegerPolynomial fp, NTRUEncryptionParameters params)
    {
        super(true, params);
