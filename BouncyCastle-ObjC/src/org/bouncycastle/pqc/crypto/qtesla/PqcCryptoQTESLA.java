...
public class PqcCryptoQTESLA
{
    ...
    private static void hashFunction(byte[] output, int outputOffset, int[] V, final byte[] message, int messageOffset, int n, int d, int q)
    {
        ...
        byte[] T = new byte[n + PqcCryptoQteslaPolynomial.MESSAGE];
        ...
        System.arraycopy(message, messageOffset, T, n, PqcCryptoQteslaPolynomial.MESSAGE);

        if (q == Parameter.Q_I)
        {

            HashUtils.secureHashAlgorithmKECCAK128(output, outputOffset, PqcCryptoQteslaPolynomial.HASH, T, 0, n + PqcCryptoQteslaPolynomial.MESSAGE);
        ...
        if (q == Parameter.Q_III_SIZE || q == Parameter.Q_III_SPEED)
        {
            ...
            HashUtils.secureHashAlgorithmKECCAK256(output, outputOffset, PqcCryptoQteslaPolynomial.HASH, T, 0, n + PqcCryptoQteslaPolynomial.MESSAGE);
    ...
    private static void hashFunction(byte[] output, int outputOffset, long[] V, final byte[] message, int messageOffset, int n, int k, int d, int q)
    {
        ...
        byte[] T = new byte[n * k + PqcCryptoQteslaPolynomial.MESSAGE];
        ...
        System.arraycopy(message, messageOffset, T, n * k, PqcCryptoQteslaPolynomial.MESSAGE);

        if (q == Parameter.Q_I_P)
        {

            HashUtils.secureHashAlgorithmKECCAK128(output, outputOffset, PqcCryptoQteslaPolynomial.HASH, T, 0, n * k + PqcCryptoQteslaPolynomial.MESSAGE);
        ...
        if (q == Parameter.Q_III_P)
        {
            ...
            HashUtils.secureHashAlgorithmKECCAK256(output, outputOffset, PqcCryptoQteslaPolynomial.HASH, T, 0, n * k + PqcCryptoQteslaPolynomial.MESSAGE);
     ...
     * @param        u        Bound in Checking Secret PqcCryptoQteslaPolynomial
     *
     ...
     * @param        q            Modulus
     * @param        rejection    Bound in Checking Error PqcCryptoQteslaPolynomial
     *
     * @return false        Valid / Accepted
     * 				true		Invalid / Rejected
     *********************************************************************************/
    ...
    /**********************************************************************************************************
     * Description:	Checks Whether the Generated Error PqcCryptoQteslaPolynomial or the Generated Secret PqcCryptoQteslaPolynomial
     ...
     *
     * @param        polynomial        Parameter to be Checked
     * @param        offset            Starting Point of the PqcCryptoQteslaPolynomial to be Checked
     * @param        bound            Threshold of Summation
     * @param        n                PqcCryptoQteslaPolynomial Degree
     * @param        h                Number of Non-Zero Entries of Output Elements of Encryption
     *
     ...
     * @param        xi
     * @param        zeta
     * @param        errorBound                            Bound in Checking Error PqcCryptoQteslaPolynomial
     * @param        secretBound                            Bound in Checking Secret PqcCryptoQteslaPolynomial
     *
        ...
        int errorBound, int secretBound)
    {
        ...
        /* Initialize Domain Separator for Error PqcCryptoQteslaPolynomial and Secret PqcCryptoQteslaPolynomial */
        int nonce = 0;

        byte[] randomness = new byte[PqcCryptoQteslaPolynomial.RANDOM];

        /* Extend Random Bytes to Seed Generation of Error PqcCryptoQteslaPolynomial and Secret PqcCryptoQteslaPolynomial */
        byte[] randomnessExtended = new byte[PqcCryptoQteslaPolynomial.SEED * 4];
        ...
        // this.rng.randomByte (randomness, (short) 0, PqcCryptoQteslaPolynomial.RANDOM);
        secureRandom.nextBytes(randomness);

        if (q == Parameter.Q_I)
        {

            HashUtils.secureHashAlgorithmKECCAK128(randomnessExtended, 0, PqcCryptoQteslaPolynomial.SEED * 4, randomness, 0, PqcCryptoQteslaPolynomial.RANDOM);
        ...
        if (q == Parameter.Q_III_SIZE || q == Parameter.Q_III_SPEED)
        {
            ...
            HashUtils.secureHashAlgorithmKECCAK256(randomnessExtended, 0, PqcCryptoQteslaPolynomial.SEED * 4, randomness, 0, PqcCryptoQteslaPolynomial.RANDOM);

        }

        /*
         * Sample the Error PqcCryptoQteslaPolynomial Fulfilling the Criteria
         * Choose All Error PqcCryptoQteslaPolynomial in R with Entries from D_SIGMA
         * Repeat Step at Iteration if the h Largest Entries of Error PqcCryptoQteslaPolynomial Summation to L_E
         */
        do
        {
        ...
        /*
         * Sample the Secret PqcCryptoQteslaPolynomial Fulfilling the Criteria
         * Choose Secret PqcCryptoQteslaPolynomial in R with Entries from D_SIGMA
         * Repeat Step if the h Largest Entries of Secret PqcCryptoQteslaPolynomial Summation to L_S
         */
        do
        {
            ...
            if (q == Parameter.Q_I)
            {
                ...
                Sample.polynomialGaussSamplerI(secretPolynomial, 0, randomnessExtended, PqcCryptoQteslaPolynomial.SEED, ++nonce);
            ...
            if (q == Parameter.Q_III_SIZE)
            {
                ...
                Sample.polynomialGaussSamplerIII(secretPolynomial, 0, randomnessExtended, PqcCryptoQteslaPolynomial.SEED, ++nonce, n, xi, Sample.EXPONENTIAL_DISTRIBUTION_III_SIZE);
            ...
            if (q == Parameter.Q_III_SPEED)
            {
                ...
                Sample.polynomialGaussSamplerIII(secretPolynomial, 0, randomnessExtended, PqcCryptoQteslaPolynomial.SEED, ++nonce, n, xi, Sample.EXPONENTIAL_DISTRIBUTION_III_SPEED);
        ...
        /* Generate Uniform PqcCryptoQteslaPolynomial A */
        PqcCryptoQteslaPolynomial.polynomialUniform(A, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * 2, n, q, qInverse, qLogarithm, generatorA, inverseNumberTheoreticTransform);

        /* Compute the Public Key T = A * secretPolynomial + errorPolynomial */
        PqcCryptoQteslaPolynomial.polynomialMultiplication(T, A, secretPolynomial, n, q, qInverse, zeta);
        PqcCryptoQteslaPolynomial.polynomialAdditionCorrection(T, T, errorPolynomial, n, q);

        /* PqcCryptoQteslaPack Public and Private Keys */
        if (q == Parameter.Q_I)
        {

            PqcCryptoQteslaPack.encodePrivateKeyI(privateKey, secretPolynomial, errorPolynomial, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * 2);
            PqcCryptoQteslaPack.encodePublicKey(publicKey, T, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * 2, Parameter.N_I, Parameter.Q_LOGARITHM_I);
        ...
        if (q == Parameter.Q_III_SIZE)
        {
            ...
            PqcCryptoQteslaPack.encodePrivateKeyIIISize(privateKey, secretPolynomial, errorPolynomial, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * 2);
            PqcCryptoQteslaPack.encodePublicKey(publicKey, T, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * 2, Parameter.N_III_SIZE, Parameter.Q_LOGARITHM_III_SIZE);
        ...
        if (q == Parameter.Q_III_SPEED)
        {
            ...
            PqcCryptoQteslaPack.encodePrivateKeyIIISpeed(privateKey, secretPolynomial, errorPolynomial, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * 2);
            PqcCryptoQteslaPack.encodePublicKeyIIISpeed(publicKey, T, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * 2);
    ...
    )
    {
        ...
        /* Extend Random Bytes to Seed Generation of Error PqcCryptoQteslaPolynomial and Secret PqcCryptoQteslaPolynomial */
        byte[] randomnessExtended = new byte[PqcCryptoQteslaPolynomial.SEED * (k + 3)];
        ...
        /* Get randomnessExtended <- seedErrorPolynomial, seedSecretPolynomial, seedA, seedY */
//        rng.randomByte(randomness, 0, PqcCryptoQteslaPolynomial.RANDOM);
        secureRandom.nextBytes (randomness);
        ...
        if (q == Parameter.Q_I_P)
        {
            ...
            HashUtils.secureHashAlgorithmKECCAK128(
                randomnessExtended, 0, PqcCryptoQteslaPolynomial.SEED * (k + 3), randomness, 0, PqcCryptoQteslaPolynomial.RANDOM
            );
        ...
        for (int i = 0; i < k; i++)
        {
            ...
            do
            {
                ...
                if (q == Parameter.Q_I_P)
                {
                    ...
                    Sample.polynomialGaussSamplerIP(errorPolynomial, n * i, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * i, ++nonce);
                ...
                if (q == Parameter.Q_III_P)
                {
                    ...
                    Sample.polynomialGaussSamplerIIIP(errorPolynomial, n * i, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * i, ++nonce);
        ...
        do
        {
            ...
            if (q == Parameter.Q_I_P)
            {
                ...
                Sample.polynomialGaussSamplerIP(secretPolynomial, 0, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * k, ++nonce);
            ...
            if (q == Parameter.Q_III_P)
            {
                ...
                Sample.polynomialGaussSamplerIIIP(secretPolynomial, 0, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * k, ++nonce);
        ...
        /* Generate Uniform PqcCryptoQteslaPolynomial A */
        PqcCryptoQteslaPolynomial.polynomialUniform(
            A, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * (k + 1), n, k, q, qInverse, qLogarithm, generatorA, inverseNumberTheoreticTransform
        );

        PqcCryptoQteslaPolynomial.polynomialNumberTheoreticTransform(secretPolynomialNumberTheoreticTransform, secretPolynomial, n);

        /* Compute the Public Key T = A * secretPolynomial + errorPolynomial */
        for (int i = 0; i < k; i++)
        {

            PqcCryptoQteslaPolynomial.polynomialMultiplication(T, n * i, A, n * i, secretPolynomialNumberTheoreticTransform, 0, n, q, qInverse);
            PqcCryptoQteslaPolynomial.polynomialAddition(T, n * i, T, n * i, errorPolynomial, n * i, n);
        ...
        /* PqcCryptoQteslaPack Public and Private Keys */
        PqcCryptoQteslaPack.packPrivateKey(privateKey, secretPolynomial, errorPolynomial, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * (k + 1), n, k);

        if (q == Parameter.Q_I_P)
        {

            PqcCryptoQteslaPack.encodePublicKeyIP(publicKey, T, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * (k + 1));
        ...
        if (q == Parameter.Q_III_P)
        {
            ...
            PqcCryptoQteslaPack.encodePublicKeyIIIP(publicKey, T, randomnessExtended, PqcCryptoQteslaPolynomial.SEED * (k + 1));
    ...
    )
    {
        ...
        byte[] C = new byte[PqcCryptoQteslaPolynomial.HASH];
        byte[] randomness = new byte[PqcCryptoQteslaPolynomial.SEED];
        byte[] randomnessInput = new byte[PqcCryptoQteslaPolynomial.RANDOM + PqcCryptoQteslaPolynomial.SEED + PqcCryptoQteslaPolynomial.MESSAGE];
        byte[] seed = new byte[PqcCryptoQteslaPolynomial.SEED * 2];
        byte[] temporaryRandomnessInput	= new byte[PqcCryptoQteslaPolynomial.RANDOM];
        ...
        if (q == Parameter.Q_I)
        {
            ...
            PqcCryptoQteslaPack.decodePrivateKeyI(seed, secretPolynomial, errorPolynomial, privateKey);
        ...
        if (q == Parameter.Q_III_SIZE)
        {
            ...
            PqcCryptoQteslaPack.decodePrivateKeyIIISize(seed, secretPolynomial, errorPolynomial, privateKey);
        ...
        if (q == Parameter.Q_III_SPEED)
        {
            ...
            PqcCryptoQteslaPack.decodePrivateKeyIIISpeed(seed, secretPolynomial, errorPolynomial, privateKey);

        }

//        rng.randomByte(randomnessInput, PqcCryptoQteslaPolynomial.RANDOM, PqcCryptoQteslaPolynomial.RANDOM);
         secureRandom.nextBytes (temporaryRandomnessInput);
         System.arraycopy (temporaryRandomnessInput, 0, randomnessInput, PqcCryptoQteslaPolynomial.RANDOM, PqcCryptoQteslaPolynomial.RANDOM);

        System.arraycopy(seed, PqcCryptoQteslaPolynomial.SEED, randomnessInput, 0, PqcCryptoQteslaPolynomial.SEED);

        if (q == Parameter.Q_I)
        {

            HashUtils.secureHashAlgorithmKECCAK128(
                randomnessInput, PqcCryptoQteslaPolynomial.RANDOM + PqcCryptoQteslaPolynomial.SEED, PqcCryptoQteslaPolynomial.MESSAGE, message, 0, messageLength
            );

            HashUtils.secureHashAlgorithmKECCAK128(
                randomness, 0, PqcCryptoQteslaPolynomial.SEED, randomnessInput, 0, PqcCryptoQteslaPolynomial.RANDOM + PqcCryptoQteslaPolynomial.SEED + PqcCryptoQteslaPolynomial.MESSAGE
            );
        ...
        PqcCryptoQteslaPolynomial.polynomialUniform(A, seed, 0, n, q, qInverse, qLogarithm, generatorA, inverseNumberTheoreticTransform);
        ...
        while (true)
        {
            ...
            /* V = A * Y Modulo Q */
            PqcCryptoQteslaPolynomial.polynomialMultiplication(V, A, Y, n, q, qInverse, zeta);

            hashFunction(C, 0, V, randomnessInput, PqcCryptoQteslaPolynomial.RANDOM + PqcCryptoQteslaPolynomial.SEED, n, d, q);

            /* Generate C = EncodeC (C') Where C' is the Hashing of V Together with Message */
            Sample.encodeC(positionList, signList, C, 0, n, h);

            PqcCryptoQteslaPolynomial.sparsePolynomialMultiplication16(SC, secretPolynomial, positionList, signList, n, h);

            /* Z = Y + EC Modulo Q */
            PqcCryptoQteslaPolynomial.polynomialAddition(Z, Y, SC, n);
            ...
            PqcCryptoQteslaPolynomial.sparsePolynomialMultiplication16(EC, errorPolynomial, positionList, signList, n, h);

            /* V = V - EC modulo Q */
            PqcCryptoQteslaPolynomial.polynomialSubtractionCorrection(V, V, EC, n, q);
            ...
            if (q == Parameter.Q_I)
            {
                /* PqcCryptoQteslaPack Signature */
                PqcCryptoQteslaPack.encodeSignature(signature, 0, C, 0, Z, n, d);
            }
            ...
            {
                /* PqcCryptoQteslaPack Signature */
                PqcCryptoQteslaPack.encodeSignatureIIISpeed(signature, 0, C, 0, Z);
            }
...
//        rng.randomByte(randomnessInput, PqcCryptoQteslaPolynomial.RANDOM, PqcCryptoQteslaPolynomial.RANDOM);
        secureRandom.nextBytes (temporaryRandomnessInput);
        System.arraycopy (temporaryRandomnessInput, 0, randomnessInput, PqcCryptoQteslaPolynomial.RANDOM, PqcCryptoQteslaPolynomial.RANDOM);
        System.arraycopy(privateKey, privateKeySize - PqcCryptoQteslaPolynomial.SEED, randomnessInput, 0, PqcCryptoQteslaPolynomial.SEED);
        ...
        PqcCryptoQteslaPolynomial.polynomialUniform(
            A, privateKey, privateKeySize - 2 * PqcCryptoQteslaPolynomial.SEED, n, k, q, qInverse, qLogarithm, generatorA, inverseNumberTheoreticTransform
        );
        ...
        while (true)
        {
            ...
            PqcCryptoQteslaPolynomial.polynomialNumberTheoreticTransform(numberTheoreticTransformY, Y, n);

            /* V_i = A_i * Y Modulo Q for All i */
            for (int i = 0; i < k; i++)
            {

                PqcCryptoQteslaPolynomial.polynomialMultiplication(V, n * i, A, n * i, numberTheoreticTransformY, 0, n, q, qInverse);

            }

            hashFunction(C, 0, V, randomnessInput, PqcCryptoQteslaPolynomial.RANDOM + PqcCryptoQteslaPolynomial.SEED, n, k, d, q);

            /* Generate C = EncodeC (C') Where C' is the Hashing of V Together with Message */
            Sample.encodeC(positionList, signList, C, 0, n, h);

            PqcCryptoQteslaPolynomial.sparsePolynomialMultiplication8(SC, 0, privateKey, 0, positionList, signList, n, h);

            /* Z = Y + EC modulo Q */
            PqcCryptoQteslaPolynomial.polynomialAddition(Z, 0, Y, 0, SC, 0, n);
            ...
            for (int i = 0; i < k; i++)
            {
                ...
                PqcCryptoQteslaPolynomial.sparsePolynomialMultiplication8(EC, n * i, privateKey, n * (i + 1), positionList, signList, n, h);

                /* V_i = V_i - EC_i Modulo Q for All k */
                PqcCryptoQteslaPolynomial.polynomialSubtraction(V, n * i, V, n * i, EC, n * i, n, q, barrettMultiplication, barrettDivision);
            ...
            {
                /* PqcCryptoQteslaPack Signature */
                PqcCryptoQteslaPack.encodeSignatureIP(signature, 0, C, 0, Z);
            ...
            {
                /* PqcCryptoQteslaPack Signature */
                PqcCryptoQteslaPack.encodeSignatureIIIP(signature, 0, C, 0, Z);
            }
    ...
    )
    {
        ...
        return signing(
            ...
            Parameter.GENERATOR_A_I_P, Parameter.INVERSE_NUMBER_THEORETIC_TRANSFORM_I_P, PqcCryptoQteslaPolynomial.PRIVATE_KEY_I_P,
    ...
    )
    {
        ...
        return signing(
            ...
            Parameter.GENERATOR_A_III_P, Parameter.INVERSE_NUMBER_THEORETIC_TRANSFORM_III_P, PqcCryptoQteslaPolynomial.PRIVATE_KEY_III_P,
    ...
    )
    {
        ...
        byte[] C = new byte[PqcCryptoQteslaPolynomial.HASH];
        byte[] cSignature = new byte[PqcCryptoQteslaPolynomial.HASH];
        byte[] seed = new byte[PqcCryptoQteslaPolynomial.SEED];
        byte[] hashMessage = new byte[PqcCryptoQteslaPolynomial.MESSAGE];
        ...
        if (q == Parameter.Q_I || q == Parameter.Q_III_SIZE)
        {
            ...
            PqcCryptoQteslaPack.decodeSignature(C, Z, signature, signatureOffset, n, d);
        ...
        if (q == Parameter.Q_III_SPEED)
        {
            ...
            PqcCryptoQteslaPack.decodeSignatureIIISpeed(C, Z, signature, signatureOffset);
        ...
        if (q == Parameter.Q_I || q == Parameter.Q_III_SIZE)
        {
            ...
            PqcCryptoQteslaPack.decodePublicKey(newPublicKey, seed, 0, publicKey, n, qLogarithm);
        ...
        if (q == Parameter.Q_III_SPEED)
        {
            ...
            PqcCryptoQteslaPack.decodePublicKeyIIISpeed(newPublicKey, seed, 0, publicKey);

        }

        /* Generate A PqcCryptoQteslaPolynomial */
        PqcCryptoQteslaPolynomial.polynomialUniform(A, seed, 0, n, q, qInverse, qLogarithm, generatorA, inverseNumberTheoreticTransform);

        Sample.encodeC(positionList, signList, C, 0, n, h);

        /* W = A * Z - TC */
        PqcCryptoQteslaPolynomial.sparsePolynomialMultiplication32(TC, newPublicKey, positionList, signList, n, h);

        PqcCryptoQteslaPolynomial.polynomialMultiplication(W, A, Z, n, q, qInverse, zeta);

        PqcCryptoQteslaPolynomial.polynomialSubtractionMontgomery(W, W, TC, n, q, qInverse, r);

        if (q == Parameter.Q_I)
        {

            HashUtils.secureHashAlgorithmKECCAK128(
                hashMessage, 0, PqcCryptoQteslaPolynomial.MESSAGE, message, 0, message.length
            );
        ...
        if (CommonFunction.memoryEqual(C, 0, cSignature, 0, PqcCryptoQteslaPolynomial.HASH) == false)
        {
            return -3;
        }
    ...
    )
    {
        ...
        return verifying(
            ...
            PqcCryptoQteslaPolynomial.SIGNATURE_I,
            Parameter.GENERATOR_A_I, Parameter.INVERSE_NUMBER_THEORETIC_TRANSFORM_I,
            Parameter.BARRETT_MULTIPLICATION_I, Parameter.BARRETT_DIVISION_I,
            PolynomialHeuristic.ZETA_I
    ...
    )
    {
        ...
        return verifying(
            ...
            PqcCryptoQteslaPolynomial.SIGNATURE_III_SIZE,
            Parameter.GENERATOR_A_III_SIZE, Parameter.INVERSE_NUMBER_THEORETIC_TRANSFORM_III_SIZE,
            Parameter.BARRETT_MULTIPLICATION_III_SIZE, Parameter.BARRETT_DIVISION_III_SIZE,
            PolynomialHeuristic.ZETA_III_SIZE
    ...
    )
    {
        ...
        return verifying(
            ...
            PqcCryptoQteslaPolynomial.SIGNATURE_III_SPEED,
            Parameter.GENERATOR_A_III_SPEED, Parameter.INVERSE_NUMBER_THEORETIC_TRANSFORM_III_SPEED,
            Parameter.BARRETT_MULTIPLICATION_III_SPEED, Parameter.BARRETT_DIVISION_III_SPEED,
            PolynomialHeuristic.ZETA_III_SPEED
    ...
    )
    {
        ...
        if (q == Parameter.Q_I_P)
        {
            ...
            PqcCryptoQteslaPack.decodeSignatureIP(C, Z, signature, signatureOffset);
        ...
        if (q == Parameter.Q_III_P)
        {
            ...
            PqcCryptoQteslaPack.decodeSignatureIIIP(C, Z, signature, signatureOffset);
        ...
        if (q == Parameter.Q_I_P)
        {
            ...
            PqcCryptoQteslaPack.decodePublicKeyIP(newPublicKey, seed, 0, publicKey);
        ...
        if (q == Parameter.Q_III_P)
        {
            ...
            PqcCryptoQteslaPack.decodePublicKeyIIIP(newPublicKey, seed, 0, publicKey);

        }

        /* Generate A PqcCryptoQteslaPolynomial */
        PqcCryptoQteslaPolynomial.polynomialUniform(A, seed, 0, n, k, q, qInverse, qLogarithm, generatorA, inverseNumberTheoreticTransform);

        Sample.encodeC(positionList, signList, C, 0, n, h);

        PqcCryptoQteslaPolynomial.polynomialNumberTheoreticTransform(numberTheoreticTransformZ, Z, n);

        /* W_i = A_i * Z_i - TC_i for All i */
        for (int i = 0; i < k; i++)
        {

            PqcCryptoQteslaPolynomial.polynomialMultiplication(W, n * i, A, n * i, numberTheoreticTransformZ, 0, n, q, qInverse);

            PqcCryptoQteslaPolynomial.sparsePolynomialMultiplication32(
                TC, n * i, newPublicKey, n * i, positionList, signList, n, h, q, barrettMultiplication, barrettDivision
            );

            PqcCryptoQteslaPolynomial.polynomialSubtraction(W, n * i, W, n * i, TC, n * i, n, q, barrettMultiplication, barrettDivision);
    ...
    )
    {
        ...
        return verifying(
            ...
            Parameter.B_I_P, Parameter.D_I_P, Parameter.U_I_P, PqcCryptoQteslaPolynomial.SIGNATURE_I_P,
            Parameter.GENERATOR_A_I_P, Parameter.INVERSE_NUMBER_THEORETIC_TRANSFORM_I_P,
            Parameter.BARRETT_MULTIPLICATION_I_P, Parameter.BARRETT_DIVISION_I_P,
            PolynomialProvablySecure.ZETA_I_P
    ...
    )
    {
        return verifying(
            ...
            Parameter.B_III_P, Parameter.D_III_P, Parameter.U_III_P, PqcCryptoQteslaPolynomial.SIGNATURE_III_P,
            Parameter.GENERATOR_A_III_P, Parameter.INVERSE_NUMBER_THEORETIC_TRANSFORM_III_P,
            Parameter.BARRETT_MULTIPLICATION_III_P, Parameter.BARRETT_DIVISION_III_P,
            PolynomialProvablySecure.ZETA_III_P
        );
