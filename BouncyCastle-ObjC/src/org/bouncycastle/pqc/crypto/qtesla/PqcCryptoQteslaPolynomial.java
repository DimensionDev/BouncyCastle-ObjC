...
class PqcCryptoQteslaPolynomial
{
     ...
     * Z is A PqcCryptoQteslaPolynomial Bounded by B and C is the Output of A Hashed String
     */
    ...
    /**
     * Size of the Public Key (in Byte) Containing seedA and PqcCryptoQteslaPolynomial T for Heuristic qTESLA Security Category-1
     */
    public static final int PUBLIC_KEY_I = (Parameter.N_I * Parameter.K_I * Parameter.Q_LOGARITHM_I + 7) / 8 + SEED;

    /**
     * Size of the Public Key (in Byte) Containing seedA and PqcCryptoQteslaPolynomial T for Heuristic qTESLA Security Category-3 (Option for Size)
     */
    ...
    /**
     * Size of the Public Key (in Byte) Containing seedA and PqcCryptoQteslaPolynomial T for Heuristic qTESLA Security Category-3 (Option for Speed)
     */
    ...
    /**
     * Size of the Public Key (in Byte) Containing seedA and PqcCryptoQteslaPolynomial T for Provably-Secure qTESLA Security Category-1
     */
    public static final int PUBLIC_KEY_I_P = (Parameter.N_I_P * Parameter.K_I_P * Parameter.Q_LOGARITHM_I_P + 7) / 8 + SEED;

    /**
     * Size of the Public Key (in Byte) Containing seedA and PqcCryptoQteslaPolynomial T for Provably-Secure qTESLA Security Category-3
     */
    public static final int PUBLIC_KEY_III_P = (Parameter.N_III_P * Parameter.K_III_P * Parameter.Q_LOGARITHM_III_P + 7) / 8 + SEED;

    /**
     * Size of the Private Key (in Byte) Containing Polynomials (Secret PqcCryptoQteslaPolynomial and Error PqcCryptoQteslaPolynomial) and Seeds (seedA and seedY)
     * for Heuristic qTESLA Security Category-1
     */
    public static final int PRIVATE_KEY_I = Parameter.N_I * Parameter.S_BIT_I / Const.BC_BYTE_SIZE * 2 + SEED * 2;

    /**
     * Size of the Private Key (in Byte) Containing Polynomials (Secret PqcCryptoQteslaPolynomial and Error PqcCryptoQteslaPolynomial) and Seeds (seedA and seedY)
     * for Heuristic qTESLA Security Category-3 (Option for Size)
     */
    public static final int PRIVATE_KEY_III_SIZE = Parameter.N_III_SIZE * Parameter.S_BIT_III_SIZE / Const.BC_BYTE_SIZE * 2 + SEED * 2;

    /**
     * Size of the Private Key (in Byte) Containing Polynomials (Secret PqcCryptoQteslaPolynomial and Error PqcCryptoQteslaPolynomial) and Seeds (seedA and seedY)
     * for Heuristic qTESLA Security Category-3 (Option for Speed)
     */
    public static final int PRIVATE_KEY_III_SPEED = Parameter.N_III_SPEED * Parameter.S_BIT_III_SPEED / Const.BC_BYTE_SIZE * 2 + SEED * 2;
    ...
    /****************************************************************************************************************************************************
     * Description:	Component Wise PqcCryptoQteslaPolynomial Multiplication for Heuristic qTESLA Security Category-1 and Security Category-3 (Option for Size and Speed)
     *
    ...
    /******************************************************************************************************************************************************************************************************************
     * Description:	Component Wise PqcCryptoQteslaPolynomial Multiplication for Provably-Secure qTESLA Security Category-1 and Security Category-3
     *
     * @param        product                    Product = Multiplicand (*) Multiplier
    ...
    /***********************************************************************************************************************************************
     * Description:	PqcCryptoQteslaPolynomial Number Theoretic Transform for Provably-Secure qTESLA Security Category-1 and Category-3
     *
    ...
    /*******************************************************************************************************************************************
     * Description:	PqcCryptoQteslaPolynomial Multiplication for Heuristic qTESLA Security Category-1 and Category-3 (Option for Size and Speed)
     *
     * @param        product                    Product = Multiplicand * Multiplier
     * @param        multiplicand            Multiplicand Array
     * @param        multiplier                Multiplier Array
    ...
    /***************************************************************************************************************************************************************************************************
     * Description:	PqcCryptoQteslaPolynomial Multiplication for Provably-Secure qTESLA Security Category-1 and Category-3
     *
     * @param        product                    Product = Multiplicand * Multiplier
     * @param        productOffset            Starting Point of the Product Array
     * @param        multiplicand            Multiplicand Array
    ...
    /****************************************************************************************************************************************************
     * Description:	PqcCryptoQteslaPolynomial Addition for Heuristic qTESLA Security Category-1 and Category-3 (Option for Size or Speed)
    ...
    /********************************************************************************************************************************************************
     * Description:	PqcCryptoQteslaPolynomial Addition for Provably-Secure qTESLA Security Category-1 and Category-3
     * 				Q + L_E < 2 ^ (CEIL (LOGARITHM (Q, 2)))
     * 				No Necessary Reduction for Y + SC
     *
     * @param        summation            Summation = Augend + Addend
    ...
    /*************************************************************************************************************
     * Description:	PqcCryptoQteslaPolynomial Addition with Correction for Heuristic qTESLA Security Category-1 and Category-3
     * 				(Option for Size or Speed)
     * 				Q + L_E < 2 ^ (CEIL (LOGARITHM (Q, 2)))
     * 				No Necessary Reduction for Y + SC
     *
    ...
    /**********************************************************************************************************************
     * Description:	PqcCryptoQteslaPolynomial Subtraction with Correction for Heuristic qTESLA Security Category-1 and Security Category-3
     *				(Option for Size or Speed)
     *
    ...
    /*******************************************************************************************************************************************
     * Description:	PqcCryptoQteslaPolynomial Subtraction with Montgomery Reduction for Heuristic qTESLA Security Category-1 and Security Category-3
     *				(Option for Size or Speed)
     *
     * @param        difference                    Difference = Minuend (-) Subtrahend
     * @param        minuend                        Minuend Array
    ...
    /******************************************************************************************************************************************************************************************************************************
     * Description:	PqcCryptoQteslaPolynomial Subtraction for Provably-Secure qTESLA Security Category-1 and Security Category-3
     *
     * @param        difference                    Difference = Minuend (-) Subtrahend
    ...
    /******************************************************************************************************************************************************************************
     * Description:	Generation of PqcCryptoQteslaPolynomial A for Heuristic qTESLA Security Category-1 and Security Category-3 (Option for Size or Speed)
     *
     * @param        A                                    PqcCryptoQteslaPolynomial to be Generated
    ...
    public static void polynomialUniform(int[] A, byte[] seed, int seedOffset, int n, int q, long qInverse, int qLogarithm, int generatorA, int inverseNumberTheoreticTransform)
    {
        ...
        while (i < n)
        {
            ...
            if (position > (HashUtils.SECURE_HASH_ALGORITHM_KECCAK_128_RATE * numberOfBlock - Const.INT_SIZE / Const.BC_BYTE_SIZE * numberOfByte))
            {
    ...
    /**************************************************************************************************************************************************************************************
     * Description:	Generation of PqcCryptoQteslaPolynomial A for Provably-Secure qTESLA Security Category-1 and Security Category-3
     *
     * @param        A                                    PqcCryptoQteslaPolynomial to be Generated
     * @param        seed                                Kappa-Bit Seed
     * @param        seedOffset                            Starting Point of the Kappa-Bit Seed
    ...
    /**************************************************************************************************************************************************************
     * Description:	Performs Sparse PqcCryptoQteslaPolynomial Multiplication for A Value Needed During Message Signification for Heuristic qTESLA Security Category-1 and
    ...
    /*****************************************************************************************************************************************************************************************************
     * Description:	Performs Sparse PqcCryptoQteslaPolynomial Multiplication for A Value Needed During Message Signification for Provably-Secure qTESLA Security Category-1 and Category-3
     *
     * @param        product                Product of Two Polynomials
    ...
    /***********************************************************************************************************************************************************************************************************************************************************
     * Description:	Performs Sparse PqcCryptoQteslaPolynomial Multiplication for A Value Needed During Message Signification for Provably-Secure qTESLA Security Category-1 and Security Category-3
     *
     * @param        product                    Product of Two Polynomials
     * @param        productOffset            Starting Point of the Product of Two Polynomials
     * @param        publicKey                Part of the Public Key
