    ...
    private GMSSPrivateKey(ASN1Sequence mtsPrivateKey)
    {
        ...
        for (int i = 0; i < curTreehash.length; i++)
        {
            ...
            for (int j = 0; j < curTreehash[i].length; j++)
            {
                ...
                curTreehash[i][j] = new Treehash(jcaJceUtilDigestFactory.getDigest(name[0]).getClass(), statByte, statInt);
            }
        }
        ...
        for (int i = 0; i < nextTreehash.length; i++)
        {
            ...
            for (int j = 0; j < nextTreehash[i].length; j++)
            {
                ...
                nextTreehash[i][j] = new Treehash(jcaJceUtilDigestFactory.getDigest(name[0]).getClass(), statByte, statInt);
            }
        }
        ...
        for (int i = 0; i < nextNextLeaf.length; i++)
        {
            ...
            nextNextLeaf[i] = new GMSSLeaf(jcaJceUtilDigestFactory.getDigest(name[0]).getClass(), statByte, statInt);
        }
        ...
        for (int i = 0; i < upperLeaf.length; i++)
        {
            ...
            upperLeaf[i] = new GMSSLeaf(jcaJceUtilDigestFactory.getDigest(name[0]).getClass(), statByte, statInt);
        }
        ...
        for (int i = 0; i < upperTHLeaf.length; i++)
        {
            ...
            upperTHLeaf[i] = new GMSSLeaf(jcaJceUtilDigestFactory.getDigest(name[0]).getClass(), statByte, statInt);
        }
        ...
        for (int i = 0; i < nextNextRoot.length; i++)
        {
            ...
            for (int k = 0; k < nnRTreehash.length; k++)
            {
                ...
                nnRTreehash[k] = new Treehash(jcaJceUtilDigestFactory.getDigest(name[0]).getClass(), statByte, statInt);
            }
            // ---------------------------------
            ...
            nextNextRoot[i] = new GMSSRootCalc(jcaJceUtilDigestFactory.getDigest(name[0]).getClass(), statByte, statInt,
        ...
        for (int i = 0; i < nextRootSig.length; i++)
        {
            ...
            nextRootSig[i] = new GMSSRootSig(jcaJceUtilDigestFactory.getDigest(name[0]).getClass(), statByte, statInt);
        }
