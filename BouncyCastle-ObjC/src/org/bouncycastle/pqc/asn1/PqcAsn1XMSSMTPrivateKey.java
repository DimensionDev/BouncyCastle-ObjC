 ...
 * </pre>
 */
public class PqcAsn1XMSSMTPrivateKey
    extends ASN1Object
{
    ...
    public PqcAsn1XMSSMTPrivateKey(int index, byte[] secretKeySeed, byte[] secretKeyPRF, byte[] publicSeed, byte[] root, byte[] bdsState)
    {
        this.index = index;
    ...
    private PqcAsn1XMSSMTPrivateKey(ASN1Sequence seq)
    {
    ...
    public static PqcAsn1XMSSMTPrivateKey getInstance(Object o)
    {
        if (o instanceof PqcAsn1XMSSMTPrivateKey)
        {
            return (PqcAsn1XMSSMTPrivateKey)o;
        }
        else if (o != null)
        {
            return new PqcAsn1XMSSMTPrivateKey(ASN1Sequence.getInstance(o));
        }
