 ...
 * </pre>
 */
public class PqcAsn1XMSSPrivateKey
    extends ASN1Object
{
    ...
    public PqcAsn1XMSSPrivateKey(int index, byte[] secretKeySeed, byte[] secretKeyPRF, byte[] publicSeed, byte[] root, byte[] bdsState)
    {
        this.index = index;
    ...
    private PqcAsn1XMSSPrivateKey(ASN1Sequence seq)
    {
    ...
    public static PqcAsn1XMSSPrivateKey getInstance(Object o)
    {
        if (o instanceof PqcAsn1XMSSPrivateKey)
        {
            return (PqcAsn1XMSSPrivateKey)o;
        }
        else if (o != null)
        {
            return new PqcAsn1XMSSPrivateKey(ASN1Sequence.getInstance(o));
        }
