...
public class X509V2CRLGenerator
{
    ...
    public void setThisUpdate(
        Date    date)
    {
        tbsGen.setThisUpdate(new Asn1X509Time(date));
    }

    public void setNextUpdate(
        Date    date)
    {
        tbsGen.setNextUpdate(new Asn1X509Time(date));
    }
    ...
    {
        tbsGen.addCRLEntry(new ASN1Integer(userCertificate), new Asn1X509Time(revocationDate), reason);
    }
    ...
    {
        tbsGen.addCRLEntry(new ASN1Integer(userCertificate), new Asn1X509Time(revocationDate), reason, new ASN1GeneralizedTime(invalidityDate));
    }
    ...
    {
        tbsGen.addCRLEntry(new ASN1Integer(userCertificate), new Asn1X509Time(revocationDate), Extensions.getInstance(extensions));
    }
