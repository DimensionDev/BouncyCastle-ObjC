...
public class X509CertificatePair
{
     ...
     * Constructor.
     *
     * @param forward X509Certificate from the other CA to this CA.
     * @param reverse X509Certificate from this CA to the other CA.
     */
    public X509CertificatePair(
            java.security.cert.X509Certificate forward,
    ...
    {
        X509Certificate f = null;
        X509Certificate r = null;
        try
        {
            if (forward != null)
            {
                f = X509Certificate.getInstance(new ASN1InputStream(
            ...
            if (reverse != null)
            {
                r = X509Certificate.getInstance(new ASN1InputStream(
