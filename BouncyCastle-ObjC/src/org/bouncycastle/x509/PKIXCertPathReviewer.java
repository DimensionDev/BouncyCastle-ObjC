...
import org.bouncycastle.jce.provider.JcePKIXNameConstraintValidator;
 ...
 * Validation of X.509 X509Certificate Paths. Tries to find as much errors in the Path as possible.
 */
...
//                            }
    ...
    private void checkPolicy()
    {
        ...
        //
        // 6.1.3 Basic X509Certificate processing
        //
        ...
        try 
        {
            for (index = certs.size() - 1; index >= 0; index--)
            {
                ...
                //
                // 6.1.4 preparation for next X509Certificate
                //
