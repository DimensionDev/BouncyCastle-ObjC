...
class CertPathValidatorUtilities
{
    ...
    */
        ...
        if (!idp_found)
        {
            ...
            while (nodes_i.hasNext())
            {
                ...
                if (ANY_POLICY.equals(node.getValidPolicy()))
                {
                    ...
                    {
                        throw new AnnotatedException("X509Certificate policies cannot be decoded.", e);
                    }
     ...
     * @throws CertPathValidatorException if JcajceDSA parameters cannot be inherited.
     */
        ...
        throws CertPathValidatorException
    {
        ...
        for (int i = index + 1; i < certs.size(); i++)
        {
            ...
            if (!(pubKey instanceof DSAPublicKey))
            {
                throw new CertPathValidatorException(
                    "JcajceDSA parameters cannot be inherited from previous certificate.");
            }
            ...
            try
            {
                KeyFactory keyFactory = KeyFactory.getInstance("JcajceDSA", BouncyCastleProvider.PROVIDER_NAME);
        ...
        throw new CertPathValidatorException("JcajceDSA parameters cannot be inherited from previous certificate.");
    }
