...
public class TestRandomBigInteger
    extends UtilTestFixedSecureRandom
{
    /**
    ...
    {
        super(new UtilTestFixedSecureRandom.Source[] { new UtilTestFixedSecureRandom.BigInteger(BigIntegers.asUnsignedByteArray(new java.math.BigInteger(encoding, radix))) });
    }
    ...
    {
        super(new UtilTestFixedSecureRandom.Source[] { new UtilTestFixedSecureRandom.BigInteger(encoding) });
    }
    ...
    {
        super(new UtilTestFixedSecureRandom.Source[] { new UtilTestFixedSecureRandom.BigInteger(bitLength, encoding) });
    }
}
