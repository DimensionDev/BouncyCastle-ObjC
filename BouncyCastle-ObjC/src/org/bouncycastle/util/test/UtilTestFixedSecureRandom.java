 ...
 */
public class UtilTestFixedSecureRandom
    extends SecureRandom
{
     ...
     * for BigIntegers. The UtilTestFixedSecureRandom will attempt to compensate for platform differences here.
     */
    ...
    public UtilTestFixedSecureRandom(byte[] value)
    {
        this(new Source[] { new Data(value) });
    }

    public UtilTestFixedSecureRandom(
        byte[][] values)
    {
