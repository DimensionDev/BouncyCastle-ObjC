...
public class TlsUtils
{
    ...
    static void validateKeyUsage(X509Certificate c, int keyUsageBits)
        throws IOException
    {
        ...
        throws IOException
    {
        ...
        X509Certificate x509Cert = clientCertificate.getCertificateAt(0);
        ...
        try
        {
            ...
            /*
             * RFC 5246 7.4.6. Client X509Certificate
             */
            ...
            /*
             * JcajceDSA public key; the certificate MUST allow the key to be used for signing with the
