 ...
 */
public class CryptoRSAKeyPairGenerator
    implements AsymmetricCipherKeyPairGenerator
{
    ...
    public AsymmetricCipherKeyPair generateKeyPair(AsymmetricKeyParameter publicParam,
                                                   AsymmetricKeyParameter privateParam)
    {
        AsymmetricCipherKeyPair result = new AsymmetricCipherKeyPair(
                publicParam,
                privateParam);
        return result;
    }
