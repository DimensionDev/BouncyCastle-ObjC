...
/**
 * EC-JcajceDSA as described in X9.62
 */
    ...
    implements ECConstants, DSAExt
{
     ...
     * initialised with. For conventional JcajceDSA the message should be a SHA-1
    ...
    // 5.4 pg 29
    /**
     * return true if the value r and s represent a JcajceDSA signature for
     * the passed in message (for standard JcajceDSA the message should be
