...
/**
 * A CryptoIoCipherOutputStream is composed of an OutputStream and a cipher so that write() methods process
 ...
 * CryptoIoCipherInputStream.
 * <p>
 * For example, if the cipher is initialized for encryption, the CryptoIoCipherOutputStream will encrypt the
 * data before writing the encrypted data to the underlying stream.
 */
public class CryptoIoCipherOutputStream
    extends FilterOutputStream
{
    ...
    /**
     * Constructs a CryptoIoCipherOutputStream from an OutputStream and a
     * BufferedBlockCipher.
     */
    public CryptoIoCipherOutputStream(
        OutputStream os,
    ...
    /**
     * Constructs a CryptoIoCipherOutputStream from an OutputStream and a AEADBlockCipher.
     */
    public CryptoIoCipherOutputStream(OutputStream os, AEADBlockCipher cipher)
    {
        super(os);
     ...
     * <code>CryptoIoCipherOutputStream</code> calls the <code>write</code>
