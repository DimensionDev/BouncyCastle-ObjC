...
/**
 * A CryptoIoCipherInputStream is composed of an InputStream and a cipher so that read() methods return data
 * that are read in from the underlying InputStream but have been additionally processed by the
 * Cipher. The cipher must be fully initialized before being used by a CryptoIoCipherInputStream.
 * <p>
 * For example, if the Cipher is initialized for decryption, the
 * CryptoIoCipherInputStream will attempt to read in data and decrypt them,
 * before returning the decrypted data.
 */
public class CryptoIoCipherInputStream
    extends FilterInputStream
{
    ...
    /**
     * Constructs a CryptoIoCipherInputStream from an InputStream and a
     * BufferedBlockCipher.
     */
    public CryptoIoCipherInputStream(
        InputStream is,
    ...
    /**
     * Constructs a CryptoIoCipherInputStream from an InputStream and a StreamCipher.
     */
    public CryptoIoCipherInputStream(
        InputStream is,
        StreamCipher cipher)
    ...
    /**
     * Constructs a CryptoIoCipherInputStream from an InputStream and an AEADBlockCipher.
     */
    public CryptoIoCipherInputStream(
        InputStream is,
    ...
    /**
     * Constructs a CryptoIoCipherInputStream from an InputStream, a
    ...
    /**
     * Constructs a CryptoIoCipherInputStream from an InputStream, a StreamCipher, and a specified internal buffer size.
     */
    public CryptoIoCipherInputStream(
        InputStream is,
        StreamCipher cipher,
    ...
    /**
     * Constructs a CryptoIoCipherInputStream from an InputStream, an AEADBlockCipher, and a specified internal buffer size.
     */
    public CryptoIoCipherInputStream(
        InputStream is,
        AEADBlockCipher cipher,
