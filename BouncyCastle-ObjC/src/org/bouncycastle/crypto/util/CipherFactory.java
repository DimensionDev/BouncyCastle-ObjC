...
import org.bouncycastle.crypto.io.CryptoIoCipherOutputStream;
...
public class CipherFactory
{
    ...
    /**
     * Return a new CryptoIoCipherOutputStream based on the passed in cipher.
     *
     * @param dOut the output stream to write the processed data to.
     * @param cipher the cipher to use.
     * @return a BC CryptoIoCipherOutputStream using the cipher and writing to dOut.
     */
    public static CryptoIoCipherOutputStream createOutputStream(OutputStream dOut, Object cipher)
    {
        if (cipher instanceof BufferedBlockCipher)
        {
            return new CryptoIoCipherOutputStream(dOut, (BufferedBlockCipher)cipher);
        }
        if (cipher instanceof StreamCipher)
        {
            return new CryptoIoCipherOutputStream(dOut, (StreamCipher)cipher);
        }
        if (cipher instanceof AEADBlockCipher)
        {
            return new CryptoIoCipherOutputStream(dOut, (AEADBlockCipher)cipher);
        }
