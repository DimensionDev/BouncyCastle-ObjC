        ...
        throws InvalidAlgorithmParameterException, InvalidKeyException
    {
        ...
        if (opmode == Cipher.ENCRYPT_MODE || opmode == Cipher.WRAP_MODE)
        {
            ...
            else if (key instanceof IESKey)
            {
                ...
                this.otherKeyParameter = JcajceUtilECUtil.generatePrivateKeyParameter(ieKey.getPrivate());
            }
            else
            {
        ...
        else if (opmode == Cipher.DECRYPT_MODE || opmode == Cipher.UNWRAP_MODE)
        {
            ...
            {
                this.key = JcajceUtilECUtil.generatePrivateKeyParameter((PrivateKey)key);
            }
            else if (key instanceof IESKey)
            {
                IESKey ieKey = (IESKey)key;
                ...
                this.key = JcajceUtilECUtil.generatePrivateKeyParameter(ieKey.getPrivate());
            }
            else
            {
