...
public class EcAlgorithmParametersSpi
    extends java.security.AlgorithmParametersSpi
{
        ...
        throws InvalidParameterSpecException
    {
        ...
        else if (ECGenParameterSpec.class.isAssignableFrom(paramSpec))
        {
            if (curveName != null)
            {
                ASN1ObjectIdentifier namedCurveOid = JcajceUtilECUtil.getNamedCurveOid(curveName);
            ...
            {
                ASN1ObjectIdentifier namedCurveOid = JcajceUtilECUtil.getNamedCurveOid(EC5Util.convertSpec(ecParameterSpec, false));
        ...
        throws IOException
    {
        if (isASN1FormatString(format))
        {
            ...
            {
                params = new X962Parameters(JcajceUtilECUtil.getNamedCurveOid(curveName));
            }
            else
            {
