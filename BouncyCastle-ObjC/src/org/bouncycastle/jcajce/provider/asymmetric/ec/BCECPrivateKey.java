    ...
    implements ECPrivateKey, JceECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
    ...
    public byte[] getEncoded()
    {
        ...
        if (ecSpec == null)
        {
            orderBitLength = JcajceUtilECUtil.getOrderBitLength(configuration, null, this.getS());
        }
        else
        {
            orderBitLength = JcajceUtilECUtil.getOrderBitLength(configuration, ecSpec.getOrder(), this.getS());
        }
    ...
    {
        return JcajceUtilECUtil.privateKeyToString("EC", d, engineGetSpec());
    }
