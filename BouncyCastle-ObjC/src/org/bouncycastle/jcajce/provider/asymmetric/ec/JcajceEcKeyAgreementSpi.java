 ...
 */
public class JcajceEcKeyAgreementSpi
    extends BaseAgreementSpi
{
    ...
    protected JcajceEcKeyAgreementSpi(
        String kaAlgorithm,
        ...
        throws InvalidKeyException, InvalidAlgorithmParameterException
    {
        if (agreement instanceof ECMQVBasicAgreement)
        {
            ...
            if (key instanceof MQVPrivateKey)
            {
                ...
                staticPrivKey = (ECPrivateKeyParameters)
                    JcajceUtilECUtil.generatePrivateKeyParameter(mqvPrivKey.getStaticPrivateKey());
                ephemPrivKey = (ECPrivateKeyParameters)
                    JcajceUtilECUtil.generatePrivateKeyParameter(mqvPrivKey.getEphemeralPrivateKey());
            ...
            else
            {
                ...
                staticPrivKey = (ECPrivateKeyParameters)
                    JcajceUtilECUtil.generatePrivateKeyParameter((PrivateKey)key);
                ephemPrivKey = (ECPrivateKeyParameters)
                    JcajceUtilECUtil.generatePrivateKeyParameter(mqvParameterSpec.getEphemeralPrivateKey());
        ...
        else if (parameterSpec instanceof DHUParameterSpec)
        {
            ...
            staticPrivKey = (ECPrivateKeyParameters)
                JcajceUtilECUtil.generatePrivateKeyParameter((PrivateKey)key);
            ephemPrivKey = (ECPrivateKeyParameters)
                JcajceUtilECUtil.generatePrivateKeyParameter(dheParameterSpec.getEphemeralPrivateKey());
    ...
    public static class DH
        extends JcajceEcKeyAgreementSpi
    {
        public DH()
        {
