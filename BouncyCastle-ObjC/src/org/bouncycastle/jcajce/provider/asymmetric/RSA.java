...
import org.bouncycastle.jcajce.provider.asymmetric.rsa.JcajceRsaKeyFactorySpi;
...
public class RSA
{
        ...
        extends AsymmetricAlgorithmProvider
    {
        ...
        {
            provider.addAlgorithm("AlgorithmParameters.OAEP", PREFIX + "RsaAlgorithmParametersSpi$OAEP");
            provider.addAlgorithm("AlgorithmParameters.PSS", PREFIX + "RsaAlgorithmParametersSpi$PSS");
            ...
            provider.addAlgorithm("Cipher.RSA", PREFIX + "RsaCipherSpi$NoPadding");
            provider.addAlgorithm("Cipher.RSA/RAW", PREFIX + "RsaCipherSpi$NoPadding");
            provider.addAlgorithm("Cipher.RSA/PKCS1", PREFIX + "RsaCipherSpi$PKCS1v1_5Padding");
            provider.addAlgorithm("Cipher", PKCSObjectIdentifiers.rsaEncryption, PREFIX + "RsaCipherSpi$PKCS1v1_5Padding");
            provider.addAlgorithm("Cipher", X509ObjectIdentifiers.id_ea_rsa, PREFIX + "RsaCipherSpi$PKCS1v1_5Padding");
            provider.addAlgorithm("Cipher.RSA/1", PREFIX + "RsaCipherSpi$PKCS1v1_5Padding_PrivateOnly");
            provider.addAlgorithm("Cipher.RSA/2", PREFIX + "RsaCipherSpi$PKCS1v1_5Padding_PublicOnly");
            provider.addAlgorithm("Cipher.RSA/OAEP", PREFIX + "RsaCipherSpi$OAEPPadding");
            provider.addAlgorithm("Cipher", PKCSObjectIdentifiers.id_RSAES_OAEP, PREFIX + "RsaCipherSpi$OAEPPadding");
            provider.addAlgorithm("Cipher.RSA/ISO9796-1", PREFIX + "RsaCipherSpi$ISO9796d1Padding");
            ...
            provider.addAlgorithm("KeyFactory.RSA", PREFIX + "JcajceRsaKeyFactorySpi");
            provider.addAlgorithm("KeyPairGenerator.RSA", PREFIX + "JcajceRsaKeyPairGeneratorSpi");

            AsymmetricKeyInfoConverter keyFact = new JcajceRsaKeyFactorySpi();
