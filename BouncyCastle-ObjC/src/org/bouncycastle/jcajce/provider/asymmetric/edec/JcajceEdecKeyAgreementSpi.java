...
public class JcajceEdecKeyAgreementSpi
    extends BaseAgreementSpi
{
    ...
    JcajceEdecKeyAgreementSpi(String algorithm)
    {
        super(algorithm, null);
    }

    JcajceEdecKeyAgreementSpi(String algorithm, DerivationFunction kdf)
    {
        super(algorithm, kdf);
    }
    ...
    public final static class XDH
        extends JcajceEdecKeyAgreementSpi
    {
        public XDH()
        {
            super("XDH");
