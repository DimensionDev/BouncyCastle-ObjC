...
public class EC5Util
{
        ...
        java.security.spec.ECParameterSpec params)
    {
        ...
        {
            domainParameters = JcajceUtilECUtil.getDomainParameters(configuration, convertSpec(params, false));
        }
        ...
        EllipticCurve ec)
    {
        ...
        else
        {
            ...
            int m = fieldF2m.getM();
            int ks[] = JcajceUtilECUtil.convertMidTerms(fieldF2m.getMidTermsOfReductionPolynomial());
