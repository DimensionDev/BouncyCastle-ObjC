    ...
    extends KeyAgreementSpi
{
    ...
    static
    {
        ...
        nameTable.put(KISAObjectIdentifiers.id_npki_app_cmsSeed_wrap.getId(), "JcajceSEED");
        nameTable.put(KISAObjectIdentifiers.id_seedCBC.getId(), "JcajceSEED");
        nameTable.put(KISAObjectIdentifiers.id_seedMAC.getId(), "JcajceSEED");
