 ...
 * 
 * ReasonCode Hode Instruction Code Invalidity Date X509Certificate Issuer
 * (critical)
 */
class JcajceX509CRLEntryObject extends X509CRLEntry
{
    ...
    protected JcajceX509CRLEntryObject(TBSCertList.CRLEntry c)
    {
        this.c = c;
     ...
     *            X509Certificate issuer of the previous CRLEntry.
     */
    protected JcajceX509CRLEntryObject(
    ...
    public boolean equals(Object o)
    {
        ...
        if (o instanceof JcajceX509CRLEntryObject)
        {
            JcajceX509CRLEntryObject other = (JcajceX509CRLEntryObject)o;
