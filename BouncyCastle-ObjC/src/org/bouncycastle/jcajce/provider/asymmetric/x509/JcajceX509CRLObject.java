    ...
    extends X509CRL
{
        ...
        throws CRLException
    {
        ...
        {
            throw new X509ExtCRLException(
                    "Exception reading IssuingDistributionPoint", e);
        }
    }

    protected JcajceX509CRLObject(
        ...
        throws CRLException
    {
        ...
        try
        {
            this.sigAlgName = JcajceX509SignatureUtil.getSignatureName(c.getSignatureAlgorithm());
        ...
        InvalidKeyException, SignatureException
    {
        ...
        if (sigAlgParams != null)
        {
            try
            {
                ...
                JcajceX509SignatureUtil.setSignatureParameters(sig, ASN1Primitive.fromByteArray(sigAlgParams));
            }
            catch (IOException e)
            {
    ...
    private Set loadCRLEntries()
    {
        ...
        while (certs.hasMoreElements())
        {
            ...
            JcajceX509CRLEntryObject crlEntry = new JcajceX509CRLEntryObject(entry, isIndirect, previousCertificateIssuer);
    ...
    public X509CRLEntry getRevokedCertificate(BigInteger serialNumber)
    {
        ...
        while (certs.hasMoreElements())
        {
            ...
            {
                return new JcajceX509CRLEntryObject(entry, isIndirect, previousCertificateIssuer);
            }
            ...
            while (certs.hasMoreElements())
            {
                ...
                if (entry.getUserCertificate().getValue().equals(serial))
                {
                    ...
                    else
                    {
                        try
                        {
                            issuer = org.bouncycastle.asn1.x509.X509Certificate.getInstance(cert.getEncoded()).getIssuer();
                        }
    ...
    public boolean equals(Object other)
    {
        ...
        if (other instanceof JcajceX509CRLObject)
        {
            JcajceX509CRLObject crlObject = (JcajceX509CRLObject)other;
