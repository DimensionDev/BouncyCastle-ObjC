    ...
    extends CertificateFactorySpi
{
    ...
    private static final JcajceX509PEMUtil PEM_CERT_PARSER = new JcajceX509PEMUtil("CERTIFICATE");
    private static final JcajceX509PEMUtil PEM_CRL_PARSER = new JcajceX509PEMUtil("CRL");
    private static final JcajceX509PEMUtil PEM_PKCS7_PARSER = new JcajceX509PEMUtil("PKCS7");
        ...
        throws CertificateParsingException
    {
        ...
        return new JcajceX509CertificateObject(bcHelper,
                            X509Certificate.getInstance(seq));
    }
        ...
        throws CertificateParsingException
    {
        if (sData != null)
        {
            while (sDataObjectCount < sData.size())
            {
                ...
                {
                   return new JcajceX509CertificateObject(bcHelper,
                                    X509Certificate.getInstance(obj));
                }
            }
        }
    ...
    protected CRL createCRL(CertificateList c)
        throws CRLException
    {
        return new JcajceX509CRLObject(bcHelper, c);
    }
     ...
     * a PKCS#7 CRL set.  This is a PKCS#7 Asn1CmsSignedData object, with the
