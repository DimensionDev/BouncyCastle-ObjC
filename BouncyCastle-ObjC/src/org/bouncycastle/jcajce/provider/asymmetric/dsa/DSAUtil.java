...
/**
 * utility class for converting jce/jca JcajceDSA objects
...
public class DSAUtil
{
    ...
    /**
     * Return true if the passed in OID could be associated with a JcajceDSA key.
     *
     * @param algOid algorithm OID from a key.
     * @return true if it's for a JcajceDSA key, false otherwise.
     */
