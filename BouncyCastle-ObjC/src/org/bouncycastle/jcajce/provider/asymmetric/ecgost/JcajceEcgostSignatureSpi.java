...
public class JcajceEcgostSignatureSpi
    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers
{
    ...
    public JcajceEcgostSignatureSpi()
    {
        ...
        throws InvalidKeyException
    {
        ...
        else
        {
            try
            {
                ...
                param = JcajceUtilECUtil.generatePublicKeyParameter(publicKey);
            }
            catch (Exception e)
            {
                throw new InvalidKeyException("can't recognise key type in JcajceDSA based signer");
            }
        }
        ...
        throws InvalidKeyException
    {
        ...
        {
            param = JcajceUtilECUtil.generatePrivateKeyParameter(privateKey);
        }
        else
        {
    ...
    throws InvalidKeyException
    {
        return (key instanceof BCECGOST3410PublicKey) ? ((BCECGOST3410PublicKey)key).engineGetKeyParameters() : JcajceUtilECUtil.generatePublicKeyParameter(key);
    }
}
