...
import org.bouncycastle.jcajce.provider.util.jcaJceUtilDigestFactory;
    ...
    extends SignatureSpi
{
        ...
        boolean isRaw)
    {
        ...
        this.mgfDigest = jcaJceUtilDigestFactory.getDigest(paramSpec.getDigestAlgorithm());
        ...
        throws InvalidAlgorithmParameterException
    {
        ...
        if (params instanceof PSSParameterSpec)
        {
            ...
            if (originalSpec != null)
            {
                if (!jcaJceUtilDigestFactory.isSameDigest(originalSpec.getDigestAlgorithm(), newParamSpec.getDigestAlgorithm()))
                {
            ...
            if (!jcaJceUtilDigestFactory.isSameDigest(mgfParams.getDigestAlgorithm(), newParamSpec.getDigestAlgorithm()))
            {
                throw new InvalidAlgorithmParameterException("digest algorithm for MGF should be the same as for PSS parameters.");
            }
            
            Digest newDigest = jcaJceUtilDigestFactory.getDigest(mgfParams.getDigestAlgorithm());
