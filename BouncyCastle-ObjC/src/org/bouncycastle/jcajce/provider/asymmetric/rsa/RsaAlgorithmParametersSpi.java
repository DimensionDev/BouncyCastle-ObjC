...
public abstract class RsaAlgorithmParametersSpi
    extends java.security.AlgorithmParametersSpi
{
    ...
    public static class OAEP
        extends RsaAlgorithmParametersSpi
    {
        ...
        protected byte[] engineGetEncoded() 
        {
            AlgorithmIdentifier hashAlgorithm = new AlgorithmIdentifier(
                                                            jcaJceUtilDigestFactory.getOID(currentSpec.getDigestAlgorithm()),
                                                            DERNull.INSTANCE);
            MGF1ParameterSpec mgfSpec = (MGF1ParameterSpec)currentSpec.getMGFParameters();
            AlgorithmIdentifier maskGenAlgorithm = new AlgorithmIdentifier(
                                                            PKCSObjectIdentifiers.id_mgf1,
                                                            new AlgorithmIdentifier(jcaJceUtilDigestFactory.getOID(mgfSpec.getDigestAlgorithm()), DERNull.INSTANCE));
    ...
    {  
            ...
            throws IOException
        {
            ...
            AlgorithmIdentifier hashAlgorithm = new AlgorithmIdentifier(
                                                jcaJceUtilDigestFactory.getOID(pssSpec.getDigestAlgorithm()),
                                                DERNull.INSTANCE);
