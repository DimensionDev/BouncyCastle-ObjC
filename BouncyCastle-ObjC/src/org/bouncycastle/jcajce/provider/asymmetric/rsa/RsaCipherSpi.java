    ...
    extends BaseCipherSpi
{
        ...
        throws NoSuchPaddingException
    {
        ...
        Digest digest = jcaJceUtilDigestFactory.getDigest(mgfParams.getDigestAlgorithm());
    ...
    throws InvalidKeyException, InvalidAlgorithmParameterException
    {
        ...
        if (params == null || params instanceof OAEPParameterSpec)
        {
            ...
            if (params != null)
            {
                ...
                Digest digest = jcaJceUtilDigestFactory.getDigest(spec.getDigestAlgorithm());
                ...
                Digest mgfDigest = jcaJceUtilDigestFactory.getDigest(mgfParams.getDigestAlgorithm());
