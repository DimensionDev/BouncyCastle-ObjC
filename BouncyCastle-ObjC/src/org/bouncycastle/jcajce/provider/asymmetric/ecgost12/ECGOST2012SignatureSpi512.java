    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers
{
        ...
        throws InvalidKeyException
    {
        ...
        else
        {
            try
            {
                ...
                param = (ECKeyParameters) JcajceUtilECUtil.generatePublicKeyParameter(publicKey);
            }
            catch (Exception e)
            {
        ...
        throws InvalidKeyException
    {
        ...
        {
            param = (ECKeyParameters) JcajceUtilECUtil.generatePrivateKeyParameter(privateKey);
        }
        else
        {
            throw new InvalidKeyException("cannot recognise key type in ECGOST-2012-512 signer");
