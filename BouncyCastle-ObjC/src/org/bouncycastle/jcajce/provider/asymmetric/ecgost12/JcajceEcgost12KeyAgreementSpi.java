...
public class JcajceEcgost12KeyAgreementSpi
    extends BaseAgreementSpi
{
    ...
    protected JcajceEcgost12KeyAgreementSpi(
        String kaAlgorithm,
    ...
    static AsymmetricKeyParameter generatePublicKeyParameter(
        ...
        throws InvalidKeyException
    {
        return (key instanceof BCECGOST3410_2012PublicKey) ? ((BCECGOST3410_2012PublicKey)key).engineGetKeyParameters() : JcajceUtilECUtil.generatePublicKeyParameter(key);
    }
    ...
    public static class ECVKO256
        extends JcajceEcgost12KeyAgreementSpi
    {
        public ECVKO256()
        {
