    ...
    implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo info)
    {
        ...
        this.ecPublicKey = new ECPublicKeyParameters(curve.decodePoint(x9Encoding), JcajceUtilECUtil.getDomainParameters(null, spec));
...
//        ecPublicKey.getQ().
    ...
    {
        return JcajceUtilECUtil.publicKeyToString(algorithm, ecPublicKey.getQ(), engineGetSpec());
    }
