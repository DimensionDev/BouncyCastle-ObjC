...
import org.bouncycastle.jcajce.spec.JcajceGOST3410ParameterSpec;
 ...
 */
public class JcajceEcgost12KeyPairGeneratorSpi
    extends java.security.KeyPairGenerator
{
    ...
    public JcajceEcgost12KeyPairGeneratorSpi()
    {
    ...
    {
        if (params instanceof JcajceGOST3410ParameterSpec)
        {
            JcajceGOST3410ParameterSpec gostParams = (JcajceGOST3410ParameterSpec)params;
        ...
        else if (params instanceof ECGenParameterSpec || params instanceof ECNamedCurveGenParameterSpec)
        {
            ...
            init(new JcajceGOST3410ParameterSpec(curveName), random);
        }
    ...
    private void init(JcajceGOST3410ParameterSpec gostParams, SecureRandom random)
        throws InvalidAlgorithmParameterException
    {
