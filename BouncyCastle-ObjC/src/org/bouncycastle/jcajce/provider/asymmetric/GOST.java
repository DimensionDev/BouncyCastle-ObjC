...
public class GOST
{
        ...
        extends AsymmetricAlgorithmProvider
    {
        ...
        {
            provider.addAlgorithm("KeyPairGenerator.GOST3410", PREFIX + "JcajceGostKeyPairGeneratorSpi");
            ...
            provider.addAlgorithm("AlgorithmParameters.GOST3410", PREFIX + "GostAlgorithmParametersSpi");
            provider.addAlgorithm("AlgorithmParameterGenerator.GOST3410", PREFIX + "GostAlgorithmParameterGeneratorSpi");
            ...
            provider.addAlgorithm("Signature.GOST3410", PREFIX + "JcajceGostSignatureSpi");
