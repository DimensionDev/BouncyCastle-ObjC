...
public final class JcajceSipHash
{
    private JcajceSipHash()
    {
    }
        ...
        extends BaseKeyGenerator
    {
        public KeyGen()
        {
            super("JcajceSipHash", 128, new CipherKeyGenerator());
        }
    }
    ...
    {
        private static final String PREFIX = JcajceSipHash.class.getName();
