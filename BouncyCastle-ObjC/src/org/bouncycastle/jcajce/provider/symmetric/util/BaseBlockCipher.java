    ...
    implements PBE
{
    ...
    private Class[]                 availableSpecs =
                                    {
                                        ...
                                        gcmSpecClass,
                                        JcajceGOST28147ParameterSpec.class,
        ...
        throws InvalidKeyException, InvalidAlgorithmParameterException
    {
        ...
        else if (!(key instanceof JcajceRepeatedSecretKeySpec))
        {
        ...
        else if (params instanceof JcajceGOST28147ParameterSpec)
        {
            JcajceGOST28147ParameterSpec gost28147Param = (JcajceGOST28147ParameterSpec)params;

            param = new ParametersWithSBox(
                       new KeyParameter(key.getEncoded()), ((JcajceGOST28147ParameterSpec)params).getSbox());
