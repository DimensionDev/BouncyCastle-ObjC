...
public final class GOST28147
{
        ...
        extends BaseAlgorithmParameterGenerator
    {
        ...
        {
            if (genParamSpec instanceof JcajceGOST28147ParameterSpec)
            {
                  this.sBox = ((JcajceGOST28147ParameterSpec)genParamSpec).getSBox();
            }
            else
            {
        ...
        protected AlgorithmParameters engineGenerateParameters()
        {
            ...
            try
            {
                ...
                params.init(new JcajceGOST28147ParameterSpec(sBox, iv));
            }
            catch (Exception e)
            {
        ...
        extends BaseAlgorithmParameters
    {
            ...
            throws InvalidParameterSpecException
        {
            ...
            if (paramSpec == JcajceGOST28147ParameterSpec.class || paramSpec == AlgorithmParameterSpec.class)
            {
                return new JcajceGOST28147ParameterSpec(sBox, iv);
            }
            ...
            throws InvalidParameterSpecException
        {
            ...
            else if (paramSpec instanceof JcajceGOST28147ParameterSpec)
            {
                this.iv = ((JcajceGOST28147ParameterSpec)paramSpec).getIV();
                try
                {
                    this.sBox = getSBoxOID((((JcajceGOST28147ParameterSpec)paramSpec).getSBox()));
                }
