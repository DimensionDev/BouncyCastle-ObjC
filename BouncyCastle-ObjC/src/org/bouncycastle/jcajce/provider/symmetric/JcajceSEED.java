...
public final class JcajceSEED
{
    ...
    {
        private static final String PREFIX = JcajceSEED.class.getName();
        ...
        public void configure(ConfigurableProvider provider)
        {
            ...
            provider.addAlgorithm("Alg.Alias.AlgorithmParameters." + KISAObjectIdentifiers.id_seedCBC, "JcajceSEED");

            provider.addAlgorithm("AlgorithmParameterGenerator.SEED", PREFIX + "$AlgParamGen");
            provider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator." + KISAObjectIdentifiers.id_seedCBC, "JcajceSEED");
            ...
            provider.addAlgorithm("KeyGenerator.JcajceSEED", PREFIX + "$KeyGen");
            ...
            provider.addAlgorithm("SecretKeyFactory.JcajceSEED", PREFIX + "$KeyFactory");
            provider.addAlgorithm("Alg.Alias.SecretKeyFactory", KISAObjectIdentifiers.id_seedCBC, "JcajceSEED");
