 ...
 */
public class JcajceGOST3410ParameterSpec
    implements AlgorithmParameterSpec
{
     ...
     */
    public JcajceGOST3410ParameterSpec(String publicKeyParamSet)
    {
     ...
     */
    public JcajceGOST3410ParameterSpec(ASN1ObjectIdentifier publicKeyParamSet, ASN1ObjectIdentifier digestParamSet)
    {
     ...
     */
    public JcajceGOST3410ParameterSpec(ASN1ObjectIdentifier publicKeyParamSet, ASN1ObjectIdentifier digestParamSet, ASN1ObjectIdentifier encryptionParamSet)
    {
