    ...
    extends ASN1Object
{
    ...
    private Asn1OcspCertStatus certStatus;
    ...
    private SingleResponse(
        ASN1Sequence    seq)
    {
        this.certID = OcspCertID.getInstance(seq.getObjectAt(0));
        this.certStatus = Asn1OcspCertStatus.getInstance(seq.getObjectAt(1));
    ...
    public Asn1OcspCertStatus getCertStatus()
    {
        return certStatus;
    }
