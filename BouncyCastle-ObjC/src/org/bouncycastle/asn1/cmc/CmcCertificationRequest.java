...
/**
 * <pre>
 *   CmcCertificationRequest ::= SEQUENCE {
 ...
 *       attributes                [0] IMPLICIT SET OF CmsAttribute },
 *    signatureAlgorithm        AlgorithmIdentifier,
 *    signature                 BIT STRING
 *  }
 * </pre>
 */
public class CmcCertificationRequest
    extends ASN1Object
{
    ...
    public CmcCertificationRequest(
        X500Name                subject,
    ...
    private CmcCertificationRequest(ASN1Sequence seq)
    {
        if (seq.size() != 3)
        {
    ...
    public static CmcCertificationRequest getInstance(Object o)
    {
        if (o instanceof CmcCertificationRequest)
        {
            return (CmcCertificationRequest)o;
        }

        if (o != null)
        {
            return new CmcCertificationRequest(ASN1Sequence.getInstance(o));
        }
