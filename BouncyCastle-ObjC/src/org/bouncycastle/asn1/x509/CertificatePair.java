 ...
 *         forward        [0]    X509Certificate OPTIONAL,
 *         reverse        [1]    X509Certificate OPTIONAL,
    ...
    extends ASN1Object
{
    ...
    private CertificatePair(ASN1Sequence seq)
    {
        ...
        while (e.hasMoreElements())
        {
            ...
            if (o.getTagNo() == 0)
            {
                forward = X509Certificate.getInstance(o, true);
            }
            else if (o.getTagNo() == 1)
            {
                reverse = X509Certificate.getInstance(o, true);
            }
            else
            {
     ...
     */
    public CertificatePair(X509Certificate forward, X509Certificate reverse)
    {
