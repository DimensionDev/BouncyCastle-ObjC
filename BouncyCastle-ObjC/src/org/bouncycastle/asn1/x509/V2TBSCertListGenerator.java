 ...
 *       issuer                  Name,
 *       thisUpdate              Asn1CmsTime,
 *       nextUpdate              Asn1CmsTime OPTIONAL,
 *       revokedCertificates     SEQUENCE OF SEQUENCE  {
 *            userCertificate         CertificateSerialNumber,
 *            revocationDate          Asn1CmsTime,
...
public class V2TBSCertListGenerator
{
    ...
    private Asn1X509Time thisUpdate, nextUpdate=null;
    ...
    {
        this.thisUpdate = new Asn1X509Time(thisUpdate);
    }

    public void setNextUpdate(
        ASN1UTCTime nextUpdate)
    {
        this.nextUpdate = new Asn1X509Time(nextUpdate);
    }

    public void setThisUpdate(
        Asn1X509Time thisUpdate)
    {
        this.thisUpdate = thisUpdate;
    }

    public void setNextUpdate(
        Asn1X509Time nextUpdate)
    {
    ...
    {
        addCRLEntry(userCertificate, new Asn1X509Time(revocationDate), reason);
    }

    public void addCRLEntry(ASN1Integer userCertificate, Asn1X509Time revocationDate, int reason)
    {
        addCRLEntry(userCertificate, revocationDate, reason, null);
    }

    public void addCRLEntry(ASN1Integer userCertificate, Asn1X509Time revocationDate, int reason, ASN1GeneralizedTime invalidityDate)
    {
        if (reason != 0)
        {
    ...
    private void internalAddCRLEntry(ASN1Integer userCertificate, Asn1X509Time revocationDate, ASN1Sequence extensions)
    {
        ASN1EncodableVector v = new ASN1EncodableVector();
    ...
    public void addCRLEntry(ASN1Integer userCertificate, Asn1X509Time revocationDate, Extensions extensions)
    {
        ASN1EncodableVector v = new ASN1EncodableVector();
