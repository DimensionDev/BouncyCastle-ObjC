    ...
    extends ASN1Object
{
        ...
        extends ASN1Object
    {
        ...
        public Asn1X509Time getRevocationDate()
        {
            return Asn1X509Time.getInstance(seq.getObjectAt(1));
        }
        ...
        ASN1Sequence  seq)
    {
        ...
        thisUpdate = Asn1X509Time.getInstance(seq.getObjectAt(seqPos++));

        if (seqPos < seq.size()
            && (seq.getObjectAt(seqPos) instanceof ASN1UTCTime
               || seq.getObjectAt(seqPos) instanceof ASN1GeneralizedTime
               || seq.getObjectAt(seqPos) instanceof Asn1X509Time))
        {
            nextUpdate = Asn1X509Time.getInstance(seq.getObjectAt(seqPos++));
        }
    ...
    public Asn1X509Time getThisUpdate()
    {
        return thisUpdate;
    }

    public Asn1X509Time getNextUpdate()
    {
        return nextUpdate;
    }
