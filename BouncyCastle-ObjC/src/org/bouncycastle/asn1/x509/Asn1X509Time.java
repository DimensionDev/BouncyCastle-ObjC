...
public class Asn1X509Time
    extends ASN1Object
    implements ASN1Choice
{
    ASN1Primitive time;

    public static Asn1X509Time getInstance(
    ...
    public static Asn1X509Time getInstance(
        Object  obj)
    {
        if (obj == null || obj instanceof Asn1X509Time)
        {
            return (Asn1X509Time)obj;
        }
        else if (obj instanceof ASN1UTCTime)
        {
            return new Asn1X509Time((ASN1UTCTime)obj);
        }
        else if (obj instanceof ASN1GeneralizedTime)
        {
            return new Asn1X509Time((ASN1GeneralizedTime)obj);
        }
