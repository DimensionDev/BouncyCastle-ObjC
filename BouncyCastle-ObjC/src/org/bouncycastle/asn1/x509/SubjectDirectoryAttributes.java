 ...
 *     Attributes ::= SEQUENCE SIZE (1..MAX) OF CmsAttribute
    ...
    extends ASN1Object
{
    ...
    private SubjectDirectoryAttributes(ASN1Sequence seq)
    {
        ...
        while (e.hasMoreElements())
        {
            ...
            attributes.addElement(X509Attribute.getInstance(s));
        }
    }
     ...
     * 
     * The vector consists of attributes of type {@link X509Attribute CmsAttribute}
     * 
     * @param attributes
     *            The attributes.
     * 
    ...
    public ASN1Primitive toASN1Primitive()
    {
        ...
        while (e.hasMoreElements())
        {
            ...
            vec.add((X509Attribute)e.nextElement());
        }
