    ...
    implements ASN1Choice
{
    ...
    public static RequestedCertificate getInstance(Object obj)
    {
        ...
        {
            return new RequestedCertificate(X509Certificate.getInstance(obj));
        }
     ...
     *
     * @param certificate          Given as X509Certificate
     */
    public RequestedCertificate(X509Certificate certificate)
    {
