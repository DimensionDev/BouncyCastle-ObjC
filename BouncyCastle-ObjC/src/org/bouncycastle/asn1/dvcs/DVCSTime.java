 ...
 *         timeStampToken               Asn1CmsContentInfo
 *     }
 * </pre>
 */
    ...
    implements ASN1Choice
{
    ...
    private final Asn1CmsContentInfo timeStampToken;
    ...
    public DVCSTime(Asn1CmsContentInfo timeStampToken)
    {
        this.genTime = null;
    ...
    public static DVCSTime getInstance(Object obj)
    {
        ...
        {
            return new DVCSTime(Asn1CmsContentInfo.getInstance(obj));
        }
