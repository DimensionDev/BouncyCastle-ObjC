...
import org.bouncycastle.asn1.ocsp.OcspCertID;
import org.bouncycastle.asn1.ocsp.Asn1OcspCertStatus;
 ...
 * <pre>
 * CertEtcToken ::= CHOICE {
 *         certificate                  [0] IMPLICIT X509Certificate ,
 *         esscertid                    [1] ESSCertId ,
 *         pkistatus                    [2] IMPLICIT PKIStatusInfo ,
 *         assertion                    [3] Asn1CmsContentInfo ,
 *         crl                          [4] IMPLICIT CertificateList,
 *         ocspcertstatus               [5] Asn1CmpCertStatus,
    ...
    implements ASN1Choice
{
    ...
    private CertEtcToken(ASN1TaggedObject choice)
    {
        ...
        case TAG_CERTIFICATE:
            value = X509Certificate.getInstance(choice, false);
            break;
        case TAG_ESSCERTID:
        ...
        case TAG_PKISTATUS:
            ...
            break;
        case TAG_ASSERTION:
            value = Asn1CmsContentInfo.getInstance(choice.getObject());
            break;
        case TAG_CRL:
            value = CertificateList.getInstance(choice, false);
            break;
        case TAG_OCSPCERTSTATUS:
            value = Asn1OcspCertStatus.getInstance(choice.getObject());
            break;
        case TAG_OCSPCERTID:
            value = OcspCertID.getInstance(choice, false);
            break;
