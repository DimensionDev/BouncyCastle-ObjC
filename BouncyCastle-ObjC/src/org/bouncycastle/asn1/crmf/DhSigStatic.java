 ...
 *         IssuerAndSerial Asn1CmsIssuerAndSerialNumber OPTIONAL,
...
public class DhSigStatic
    extends ASN1Object
{
    private final Asn1CmsIssuerAndSerialNumber issuerAndSerial;
    ...
    public DhSigStatic(Asn1CmsIssuerAndSerialNumber issuerAndSerial, byte[] hashValue)
    {
    ...
    private DhSigStatic(ASN1Sequence seq)
    {
        ...
        {
            issuerAndSerial = Asn1CmsIssuerAndSerialNumber.getInstance(seq.getObjectAt(0));
    ...
    public Asn1CmsIssuerAndSerialNumber getIssuerAndSerial()
    {
