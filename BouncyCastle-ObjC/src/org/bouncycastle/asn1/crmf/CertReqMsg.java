    ...
    extends ASN1Object
{
    ...
    public CrmfAttributeTypeAndValue[] getRegInfo()
    {
        if (regInfo == null)
        {
            return null;
        ...
        CrmfAttributeTypeAndValue[] results = new CrmfAttributeTypeAndValue[regInfo.size()];

        for (int i = 0; i != results.length; i++)
        {
            results[i] = CrmfAttributeTypeAndValue.getInstance(regInfo.getObjectAt(i));
        }
     ...
     *                    regInfo   SEQUENCE SIZE(1..MAX) OF CrmfAttributeTypeAndValue OPTIONAL }
     * </pre>
