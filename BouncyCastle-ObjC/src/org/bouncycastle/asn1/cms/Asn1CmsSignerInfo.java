 ...
 * -- {@link Asn1CmsSignedData} certificates element.
 *
 * SignerIdentifier ::= CHOICE {
 *     issuerAndSerialNumber {@link Asn1CmsIssuerAndSerialNumber},
 *     subjectKeyIdentifier  [0] SubjectKeyIdentifier }
 *
 * -- See {@link Attributes} for generalized SET OF {@link CmsAttribute}
 *
 * SignedAttributes   ::= SET SIZE (1..MAX) OF CmsAttribute
 * UnsignedAttributes ::= SET SIZE (1..MAX) OF CmsAttribute
 * 
 * {@link CmsAttribute} ::= SEQUENCE {
 ...
 * </pre>
 */
public class Asn1CmsSignerInfo
    extends ASN1Object
{
    ...
    /**
     * Return a Asn1CmsSignerInfo object from the given input
     * <p>
     * Accepted inputs:
     * <ul>
     * <li> null &rarr; null
     * <li> {@link Asn1CmsSignerInfo} object
     * <li> {@link org.bouncycastle.asn1.ASN1Sequence#getInstance(java.lang.Object) ASN1Sequence} input formats with Asn1CmsSignerInfo structure inside
     * </ul>
     *
     * @param o the object we want converted.
     * @exception IllegalArgumentException if the object cannot be converted.
     */
    public static Asn1CmsSignerInfo getInstance(
        Object  o)
        throws IllegalArgumentException
    {
        if (o instanceof Asn1CmsSignerInfo)
        {
            return (Asn1CmsSignerInfo)o;
        }
        else if (o != null)
        {
            return new Asn1CmsSignerInfo(ASN1Sequence.getInstance(o));
        }
