 ...
 * <p>
 * A signed data object containing multitude of {@link Asn1CmsSignerInfo}s.
 * <pre>
 * Asn1CmsSignedData ::= SEQUENCE {
 *     version CMSVersion,
 ...
 * 
 * SignerInfos ::= SET OF Asn1CmsSignerInfo
 * </pre>
 * <p>
 ...
 *          (any Asn1CmsSignerInfo structures are version 3) OR
 ...
 * <p>
 */
public class Asn1CmsSignedData
    extends ASN1Object
{
    ...
    private Asn1CmsContentInfo contentInfo;
    ...
    /**
     * Return a Asn1CmsSignedData object from the given object.
     * <p>
     * Accepted inputs:
     * <ul>
     * <li> null &rarr; null
     * <li> {@link Asn1CmsSignedData} object
     * <li> {@link org.bouncycastle.asn1.ASN1Sequence#getInstance(java.lang.Object) ASN1Sequence} input formats with Asn1CmsSignedData structure inside
     * </ul>
     *
     * @param o the object we want converted.
     * @return a reference that can be assigned to Asn1CmsSignedData (may be null)
     * @throws IllegalArgumentException if the object cannot be converted.
     */
    public static Asn1CmsSignedData getInstance(
        Object  o)
    {
        if (o instanceof Asn1CmsSignedData)
        {
            return (Asn1CmsSignedData)o;
        }
        else if (o != null)
        {
            return new Asn1CmsSignedData(ASN1Sequence.getInstance(o));
        }

        return null;
    }

    public Asn1CmsSignedData(
        ASN1Set     digestAlgorithms,
        Asn1CmsContentInfo contentInfo,
    ...
    private boolean checkForVersion3(ASN1Set signerInfs)
    {
        ...
        {
            Asn1CmsSignerInfo s = Asn1CmsSignerInfo.getInstance(e.nextElement());
        ...
        ASN1Sequence seq)
    {
        ...
        contentInfo = Asn1CmsContentInfo.getInstance(e.nextElement());
        ...
        while (e.hasMoreElements())
        {
            ...
            //
            // an interesting feature of Asn1CmsSignedData is that there appear
