 ...
 *     issuerAndSerialNumber Asn1CmsIssuerAndSerialNumber,
    ...
    implements ASN1Choice
{
    ...
    public OriginatorIdentifierOrKey(
        Asn1CmsIssuerAndSerialNumber id)
    {
        this.id = id;
    }
     ...
     * <li> {@link org.bouncycastle.asn1.ASN1TaggedObject#getInstance(java.lang.Object) ASN1TaggedObject} input formats with Asn1CmsIssuerAndSerialNumber structure inside
     * </ul>
     *
        ...
        Object o)
    {
        ...
        if (o instanceof Asn1CmsIssuerAndSerialNumber || o instanceof ASN1Sequence)
        {
            return new OriginatorIdentifierOrKey(Asn1CmsIssuerAndSerialNumber.getInstance(o));
        }
    ...
    public Asn1CmsIssuerAndSerialNumber getIssuerAndSerialNumber()
    {
        if (id instanceof Asn1CmsIssuerAndSerialNumber)
        {
            return (Asn1CmsIssuerAndSerialNumber)id;
        }
