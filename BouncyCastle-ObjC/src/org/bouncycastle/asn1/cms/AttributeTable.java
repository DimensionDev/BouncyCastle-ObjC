...
public class AttributeTable
{
        ...
        ASN1EncodableVector v)
    {
        ...
        {
            CmsAttribute a = CmsAttribute.getInstance(v.get(i));
        ...
        ASN1Set    s)
    {
        ...
        {
            CmsAttribute a = CmsAttribute.getInstance(s.getObjectAt(i));
        ...
        CmsAttribute a)
    {
        ...
        else
        {
            ...
            if (value instanceof CmsAttribute)
            {
                v = new Vector();
        ...
        ASN1ObjectIdentifier oid)
    {
        ...
        {
            return (CmsAttribute)((Vector)value).elementAt(0);
        }
        
        return (CmsAttribute)value;
    }
        ...
        ASN1ObjectIdentifier oid)
    {
        ...
        if (value instanceof Vector)
        {
            ...
            {
                v.add((CmsAttribute)e.nextElement());
            }
        }
        else if (value != null)
        {
            v.add((CmsAttribute)value);
        }
    ...
    public ASN1EncodableVector toASN1EncodableVector()
    {
        ...
        while (e.hasMoreElements())
        {
            ...
            if (value instanceof Vector)
            {
                ...
                {
                    v.add(CmsAttribute.getInstance(en.nextElement()));
                }
            }
            else
            {
                v.add(CmsAttribute.getInstance(value));
            }
        }
    ...
    public AttributeTable add(ASN1ObjectIdentifier attrType, ASN1Encodable attrValue)
    {
        ...
        newTable.addAttribute(attrType, new CmsAttribute(attrType, new DERSet(attrValue)));
