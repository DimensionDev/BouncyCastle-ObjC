...
{
    private Asn1CmsIssuerAndSerialNumber issuerSerial;
        ...
        Object obj)
    {
        ...
        {
            return new KeyAgreeRecipientIdentifier(Asn1CmsIssuerAndSerialNumber.getInstance(obj));
        }
    ...
    public KeyAgreeRecipientIdentifier(
        Asn1CmsIssuerAndSerialNumber issuerSerial)
    {
