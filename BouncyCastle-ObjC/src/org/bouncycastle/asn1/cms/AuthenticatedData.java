    ...
    extends ASN1Object
{
    ...
    private Asn1CmsContentInfo encapsulatedContentInfo;
    ...
    public AuthenticatedData(
        ...
        Asn1CmsContentInfo encapsulatedContent,
        ASN1Set authAttrs,
        ASN1OctetString mac,
        ASN1Set unauthAttrs)
    {
        ...
        ASN1Sequence seq)
    {
        ...
        encapsulatedContentInfo = Asn1CmsContentInfo.getInstance(tmp);
    ...
    public Asn1CmsContentInfo getEncapsulatedContentInfo()
    {
