    ...
    extends ASN1Object
{
    ...
    public static final int profileType = 0x7f;//Profile type X509Certificate
    public static final int requestType = 0x0D;// Request type X509Certificate
     ...
     * storing sensitive data. This functions returns the X509Certificate Holder
     * Authorization
     *
        ...
        throws IOException
    {
        ...
        throw new IOException("X509Certificate Holder Authorisation not set");
    }

    /**
     * set the CertificateHolderAuthorization
     *
     * @param cha the X509Certificate Holder Authorization
     */
