 ...
 * <pre>
 *  X509Certificate Holder Authorization ::= SEQUENCE {
 ...
 * </pre>
 */
public class Asn1EacRSAPublicKey
    extends PublicKeyDataObject
{
    ...
    Asn1EacRSAPublicKey(ASN1Sequence seq)
    {
    ...
    public Asn1EacRSAPublicKey(ASN1ObjectIdentifier usage, BigInteger modulus, BigInteger exponent)
    {
        this.usage = usage;
