...
import org.bouncycastle.asn1.pkcs.PkcsAttribute;

/**
 * <pre>
 *    AttrOrOID ::= CHOICE (oid OBJECT IDENTIFIER, attribute CmsAttribute }
 * </pre>
 */
    ...
    implements ASN1Choice
{
    ...
    private final PkcsAttribute attribute;
    ...
    public AttrOrOID(PkcsAttribute attribute)
    {
        this.oid = null;
        ...
        Object obj)
    {
        ...
        if (obj != null)
        {
            if (obj instanceof ASN1Encodable)
            {
                ...
                {
                    return new AttrOrOID(PkcsAttribute.getInstance(asn1Prim));
                }
            }
    ...
    public PkcsAttribute getAttribute()
    {
        return attribute;
    }
