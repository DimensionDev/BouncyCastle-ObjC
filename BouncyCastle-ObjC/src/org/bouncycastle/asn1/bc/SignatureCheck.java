    ...
    extends ASN1Object
{
    ...
    public SignatureCheck(AlgorithmIdentifier signatureAlgorithm, X509Certificate[] certificates, byte[] signature)
    {
        this.signatureAlgorithm = signatureAlgorithm;
    ...
    public X509Certificate[] getCertificates()
    {
        ...
        {
            certs[i] = X509Certificate.getInstance(certificates.getObjectAt(i));
        }
