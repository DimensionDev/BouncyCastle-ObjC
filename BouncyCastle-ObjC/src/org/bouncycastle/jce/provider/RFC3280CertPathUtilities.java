...
{
    private static final JcePKIXCRLUtil CRL_UTIL = new JcePKIXCRLUtil();
        ...
        throws AnnotatedException
    {
        ...
        try
        {
            idp = IssuingDistributionPoint.getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue(crl,
        ...
        if (idp != null)
        {
            ...
            try
            {
                bc = BasicConstraints.getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue((X509Extension)cert,
                    BASIC_CONSTRAINTS));
            }
            catch (Exception e)
            {
    ...
    protected static void processCRLB1(
        ...
        throws AnnotatedException
    {
        ASN1Primitive idp = JceProviderCertPathValidatorUtilities.getExtensionValue(crl, ISSUING_DISTRIBUTION_POINT);
        ...
        throws AnnotatedException
    {
        ...
        try
        {
            coll = JceProviderCertPathValidatorUtilities.findCertificates(selector, paramsPKIX.getCertificateStores());
            coll.addAll(JceProviderCertPathValidatorUtilities.findCertificates(selector, paramsPKIX.getCertStores()));
        }
        ...
        while (cert_it.hasNext())
        {
            ...
            try
            {
                ...
                validCerts.add(signingCert);
                validKeys.add(JceProviderCertPathValidatorUtilities.getNextWorkingKey(certs, 0, helper));
            }
        ...
        if (paramsPKIX.isUseDeltasEnabled())
        {
            ...
            try
            {
                freshestCRL = CRLDistPoint
                    .getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue(cert, FRESHEST_CRL));
            }
            catch (AnnotatedException e)
            {
            ...
            if (freshestCRL == null)
            {
                try
                {
                    freshestCRL = CRLDistPoint.getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue(crl,
                        FRESHEST_CRL));
                }
                catch (AnnotatedException e)
                {
            ...
            if (freshestCRL != null)
            {
                ...
                try
                {
                    crlStores.addAll(JceProviderCertPathValidatorUtilities.getAdditionalStoresFromCRLDistributionPoint(freshestCRL, paramsPKIX.getNamedCRLStoreMap()));
                }
                catch (AnnotatedException e)
                {
                    throw new AnnotatedException(
                ...
                try
                {
                    set.addAll(JceProviderCertPathValidatorUtilities.getDeltaCRLs(currentDate, crl, paramsPKIX.getCertStores(), crlStores));
                }
                catch (AnnotatedException e)
                {
        ...
        throws AnnotatedException
    {
        ...
        if (paramsPKIX.isUseDeltasEnabled())
        {
            ...
            try
            {
                deltaSet.addAll(JceProviderCertPathValidatorUtilities.getDeltaCRLs(validityDate, crl, paramsPKIX.getCertStores(), paramsPKIX.getCRLStores()));
            }
            catch (AnnotatedException e)
            {
                throw new AnnotatedException("Exception obtaining delta CRLs.", e);
        ...
        throws AnnotatedException
    {
        ...
        try
        {
            completeidp = IssuingDistributionPoint.getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue(
        ...
        if (pkixParams.isUseDeltasEnabled())
        {
            ...
            try
            {
                deltaidp = IssuingDistributionPoint.getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue(
            ...
            try
            {
                completeKeyIdentifier = JceProviderCertPathValidatorUtilities.getExtensionValue(
            ...
            try
            {
                deltaKeyIdentifier = JceProviderCertPathValidatorUtilities.getExtensionValue(
    ...
    protected static void processCRLI(
        ...
        X509CRL deltacrl,
        Object cert,
        JceProviderCertStatus certStatus,
        PKIXExtendedParameters pkixParams)
        throws AnnotatedException
    {
        if (pkixParams.isUseDeltasEnabled() && deltacrl != null)
        {
            JceProviderCertPathValidatorUtilities.getCertStatus(validDate, deltacrl, cert, certStatus);
        }
    }
    ...
    protected static void processCRLJ(
        ...
        throws AnnotatedException
    {
        if (certStatus.getCertStatus() == JceProviderCertStatus.UNREVOKED)
        {
            JceProviderCertPathValidatorUtilities.getCertStatus(validDate, completecrl, cert, certStatus);
        }
    }
        ...
        throws CertPathValidatorException
    {
        ...
        try
        {
            pm = DERSequence.getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue(cert,
                    ...
                    if (!idp_found)
                    {
                        ...
                        while (nodes_i.hasNext())
                        {
                            ...
                            if (RFC3280CertPathUtilities.ANY_POLICY.equals(node.getValidPolicy()))
                            {
                                ...
                                try
                                {
                                    policies = (ASN1Sequence) JceProviderCertPathValidatorUtilities.getExtensionValue(cert,
                                ...
                                while (e.hasMoreElements())
                                {
                                    ...
                                    if (RFC3280CertPathUtilities.ANY_POLICY.equals(pinfo.getPolicyIdentifier().getId()))
                                    {
                                        try
                                        {
                                            pq = JceProviderCertPathValidatorUtilities
                        ...
                        if (node.getValidPolicy().equals(id_p))
                        {
                            ...
                            for (int k = (i - 1); k >= 0; k--)
                            {
                                ...
                                for (int l = 0; l < nodes.size(); l++)
                                {
                                    ...
                                    {
                                        _validPolicyTree = JceProviderCertPathValidatorUtilities.removePolicyNode(
        ...
        throws CertPathValidatorException
    {
        ...
        try
        {
            certPolicies = DERSequence.getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue(cert,
                RFC3280CertPathUtilities.CERTIFICATE_POLICIES));
        }
        catch (AnnotatedException e)
        {
    ...
    protected static void processCertBC(
        CertPath certPath,
        int index,
        JcePKIXNameConstraintValidator nameConstraintValidator)
        throws CertPathValidatorException
    {
        List certs = certPath.getCertificates();
        X509Certificate cert = (X509Certificate)certs.get(index);
        ...
        //
        if (!(JceProviderCertPathValidatorUtilities.isSelfIssued(cert) && (i < n)))
        {
            ...
            try
            {
                altName = GeneralNames.getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue(cert,
        ...
        if (certPolicies != null && validPolicyTree != null)
        {
            ...
            while (e.hasMoreElements())
            {
                ...
                if (!RFC3280CertPathUtilities.ANY_POLICY.equals(pOid.getId()))
                {
                    ...
                    try
                    {
                        pq = JceProviderCertPathValidatorUtilities.getQualifierSet(pInfo.getPolicyQualifiers());
                    }
                    catch (CertPathValidatorException ex)
                    {
                    ...
                    boolean match = JceProviderCertPathValidatorUtilities.processCertD1i(i, policyNodes, pOid, pq);

                    if (!match)
                    {
                        JceProviderCertPathValidatorUtilities.processCertD1ii(i, policyNodes, pOid, pq);
                    }
                }
            }
            ...
            // (d) (2)
            //
            if ((inhibitAnyPolicy > 0) || ((i < n) && JceProviderCertPathValidatorUtilities.isSelfIssued(cert)))
            {
                ...
                while (e.hasMoreElements())
                {
                    ...
                    if (RFC3280CertPathUtilities.ANY_POLICY.equals(pInfo.getPolicyIdentifier().getId()))
                    {
                        Set _apq = JceProviderCertPathValidatorUtilities.getQualifierSet(pInfo.getPolicyQualifiers());
            ...
            for (int j = (i - 1); j >= 0; j--)
            {
                ...
                for (int k = 0; k < nodes.size(); k++)
                {
                    ...
                    if (!node.hasChildren())
                    {
                        _validPolicyTree = JceProviderCertPathValidatorUtilities.removePolicyNode(_validPolicyTree, policyNodes,
                            node);
                        if (_validPolicyTree == null)
                        {
                            break;
        ...
        throws ExtCertPathValidatorException
    {
        ...
        if (!verificationAlreadyPerformed)
        {
            try
            {
                // (a) (1)
                //
                JceProviderCertPathValidatorUtilities.verifyX509Certificate(cert, workingPublicKey,
        ...
        try
        {
            // (a) (2)
            //
            cert.checkValidity(JceProviderCertPathValidatorUtilities
        ...
        if (paramsPKIX.isRevocationEnabled())
        {
            try
            {
                checkCRLs(paramsPKIX, cert, JceProviderCertPathValidatorUtilities.getValidCertDateFromValidityModel(paramsPKIX,
        ...
        throws CertPathValidatorException
    {
        ...
        try
        {
            pc = DERSequence.getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue(cert,
        ...
        throws CertPathValidatorException
    {
        ...
        try
        {
            ASN1Sequence ncSeq = DERSequence.getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue(cert,
     ...
     * @param cert               X509Certificate to check if it is revoked.
        ...
        throws AnnotatedException
    {
        ...
        Set crls = JceProviderCertPathValidatorUtilities.getCompleteCRLs(dp, cert, currentDate, paramsPKIX);
        boolean validCrlFound = false;
        AnnotatedException lastException = null;
        Iterator crl_iter = crls.iterator();

        while (crl_iter.hasNext() && certStatus.getCertStatus() == JceProviderCertStatus.UNREVOKED && !reasonMask.isAllReasons())
        {
            try
            {
                ...
                {
                    // get delta CRLs
                    Set deltaCRLs = JceProviderCertPathValidatorUtilities.getDeltaCRLs(validityDate, crl, paramsPKIX.getCertStores(), paramsPKIX.getCRLStores());
                ...
                {
                    certStatus.setCertStatus(JceProviderCertStatus.UNREVOKED);
                }
        ...
        throws AnnotatedException
    {
        ...
        try
        {
            crldp = CRLDistPoint.getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue(cert,
        ...
        try
        {
            List extras = JceProviderCertPathValidatorUtilities.getAdditionalStoresFromCRLDistributionPoint(crldp, paramsPKIX.getNamedCRLStoreMap());
        ...
        JceProviderCertStatus certStatus = new JceProviderCertStatus();
        ...
        if (crldp != null)
        {
            ...
            if (dps != null)
            {
                for (int i = 0; i < dps.length && certStatus.getCertStatus() == JceProviderCertStatus.UNREVOKED && !reasonsMask.isAllReasons(); i++)
                {
                    try
                    {
        ...
        if (certStatus.getCertStatus() == JceProviderCertStatus.UNREVOKED && !reasonsMask.isAllReasons())
        {
            try
            {
                /*
        ...
        if (!reasonsMask.isAllReasons() && certStatus.getCertStatus() == JceProviderCertStatus.UNREVOKED)
        {
            certStatus.setCertStatus(JceProviderCertStatus.UNDETERMINED);
        }
        if (certStatus.getCertStatus() == JceProviderCertStatus.UNDETERMINED)
        {
        ...
        throws CertPathValidatorException
    {
        ...
        try
        {
            iap = ASN1Integer.getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue(cert,
        ...
        throws CertPathValidatorException
    {
        ...
        try
        {
            bc = BasicConstraints.getInstance(JceProviderCertPathValidatorUtilities.getExtensionValue(cert,
        ...
        throws CertPathValidatorException
    {
        ...
        // (l)
        //
        if (!JceProviderCertPathValidatorUtilities.isSelfIssued(cert))
        {
            if (maxPathLength <= 0)
            {
        ...
        X509Certificate cert)
    {
        ...
        // (a)
        //
        if (!JceProviderCertPathValidatorUtilities.isSelfIssued(cert) && (explicitPolicy != 0))
        {
            explicitPolicy--;
        }
        return explicitPolicy;
        ...
        throws CertPathValidatorException
    {
        ...
        else if (JceProviderCertPathValidatorUtilities.isAnyPolicy(userInitialPolicySet)) // (g)
        // (ii)
        {
            if (paramsPKIX.isExplicitPolicyRequired())
            {
                    ...
                    if (validPolicyTree != null)
                    {
                        for (int j = (n - 1); j >= 0; j--)
                        {
                            ...
                            for (int k = 0; k < nodes.size(); k++)
                            {
                                ...
                                if (!node.hasChildren())
                                {
                                    validPolicyTree = JceProviderCertPathValidatorUtilities.removePolicyNode(validPolicyTree,
                                        policyNodes, node);
                                }
                            }
                        }
        ...
        else
        {
            ...
            while (_vpnsIter.hasNext())
            {
                ...
                {
                    validPolicyTree = JceProviderCertPathValidatorUtilities.removePolicyNode(validPolicyTree, policyNodes, _node);
                }
            }
            ...
            if (validPolicyTree != null)
            {
                for (int j = (n - 1); j >= 0; j--)
                {
                    ...
                    for (int k = 0; k < nodes.size(); k++)
                    {
                        ...
                        if (!node.hasChildren())
                        {
                            validPolicyTree = JceProviderCertPathValidatorUtilities.removePolicyNode(validPolicyTree, policyNodes,
                                node);
                        }
                    }
                }
