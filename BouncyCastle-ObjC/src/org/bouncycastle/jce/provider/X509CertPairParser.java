    ...
    extends X509StreamParserSpi
{
    ...
    public Object engineRead() throws X509StreamParsingException
    {
        try
        {
        ...
        {
            throw new X509StreamParsingException(e.toString(), e);
        }
    }

    public Collection engineReadAll() throws X509StreamParsingException
    {
