...
public class JcePKIXNameConstraintValidator
{
    ...
    public JcePKIXNameConstraintValidator()
    {
    }
    ...
    {
        if (!(o instanceof JcePKIXNameConstraintValidator))
        {
            return false;
        }
        JcePKIXNameConstraintValidator constraintValidator = (JcePKIXNameConstraintValidator)o;
