...
/**
 * CertPathValidatorSpi implementation for X.509 CmsAttribute Certificates la RFC 3281.
 * 
    ...
    extends CertPathValidatorSpi
{
        ...
        InvalidAlgorithmParameterException
    {
        ...
        try
        {
            date = JceProviderCertPathValidatorUtilities.getValidCertDateFromValidityModel(paramsPKIX, null, -1);
        }
