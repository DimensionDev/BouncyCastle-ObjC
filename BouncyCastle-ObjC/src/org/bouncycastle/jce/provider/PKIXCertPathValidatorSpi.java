...
/**
 * CertPathValidatorSpi implementation for X.509 X509Certificate validation � la RFC
 * 3280.
 */
        ...
        extends CertPathValidatorSpi
{
            ...
            InvalidAlgorithmParameterException
    {
        ...
        // (b)
        //
        // Date validDate = JceProviderCertPathValidatorUtilities.getValidDate(paramsPKIX);
        ...
        try
        {
            trust = JceProviderCertPathValidatorUtilities.findTrustAnchor((X509Certificate) certs.get(certs.size() - 1),
        ...
        int index = 0;
        int i;
        // X509Certificate for each interation of the validation loop
        ...
        // (b) and (c)
        //
        JcePKIXNameConstraintValidator nameConstraintValidator = new JcePKIXNameConstraintValidator();
        ...
        try
        {
            workingAlgId = JceProviderCertPathValidatorUtilities.getAlgorithmIdentifier(workingPublicKey);
        }
        ...
        for (index = certs.size() - 1; index >= 0; index--)
        {
            ...
            if (i != n)
            {
                ...
                try
                {
                    workingPublicKey = JceProviderCertPathValidatorUtilities.getNextWorkingKey(certPath.getCertificates(), index, helper);
                }
                catch (CertPathValidatorException e)
                {
