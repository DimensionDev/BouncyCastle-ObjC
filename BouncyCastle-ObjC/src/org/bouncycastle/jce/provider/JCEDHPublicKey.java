    ...
    implements DHPublicKey
{
    ...
    public byte[] getEncoded()
    {
        ...
        return JcajceUtilKeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(dhSpec.getP(), dhSpec.getG(), dhSpec.getL())), new ASN1Integer(y));
    }
